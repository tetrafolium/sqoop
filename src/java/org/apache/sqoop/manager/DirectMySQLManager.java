...
public class DirectMySQLManager extends MySQLManager {
  ...
  public static final Log LOG =
      LogFactory.getLog(DirectMySQLManager.class.getName());

  public DirectMySQLManager(final SqoopOptions options) { super(options); }
  ...
  public void upsertTable(org.apache.sqoop.manager.ExportJobContext context)
    ...
    throw new ExportException(
        "MySQL direct connector does not support upsert"
