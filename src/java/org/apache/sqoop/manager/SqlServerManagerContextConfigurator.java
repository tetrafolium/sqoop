...
public class SqlServerManagerContextConfigurator {
   ...
   * using {@link SQLServerConnectionFailureHandler}. This can be overridden by
   * setting the
   * {@link SQLServerResilientExportOutputFormat#EXPORT_FAILURE_HANDLER_CLASS}
   ...
   * {@link SQLServerConnectionFailureHandler}. This can be overridden by
   * setting the
   * {@link SQLServerDBInputFormat#IMPORT_FAILURE_HANDLER_CLASS} in the
   * configuration.
   */
   ...
   */
  public boolean configureContextForUpdate(ExportJobContext context,
