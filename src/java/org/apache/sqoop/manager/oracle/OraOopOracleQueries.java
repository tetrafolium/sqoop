...
public final class OraOopOracleQueries {
  ...
  private static final OraOopLog LOG =
      OraOopLogFactory.getLog(OraOopOracleQueries.class);
  ...
  static {
    try {
      ...
      methSetLongAtName = oracleStatementClass.getMethod(
          "setLongAtName", String.class, long.class);
      methSetBigDecimalAtName = oracleStatementClass.getMethod(
          "setBigDecimalAtName", String.class, BigDecimal.class);
      methSetStringAtName = oracleStatementClass.getMethod(
          "setStringAtName", String.class, String.class);
      methSetTimestampAtName = oracleStatementClass.getMethod(
          "setTimestampAtName", String.class, Timestamp.class);
      methSetBinaryDoubleAtName = oracleStatementClass.getMethod(
          "setBinaryDoubleAtName", String.class, double.class);
      methSetObjectAtName = oracleStatementClass.getMethod(
          "setObjectAtName", String.class, Object.class);
      methSetBinaryFloatAtName = oracleStatementClass.getMethod(
          "setBinaryFloatAtName", String.class, float.class);
      methSetIntAtName = oracleStatementClass.getMethod(
          "setIntAtName", String.class, int.class);
  ...
  setJdbcFetchSize(Connection connection,
                   org.apache.hadoop.conf.Configuration conf) {

    int fetchSize = conf.getInt(OraOopConstants.ORACLE_ROW_FETCH_SIZE,
    ...
    try {
      ...
      LOG.warn(
          String.format("Unable to configure the DefaultRowPrefetch of the "
  ...
  getOracleDataChunksPartition(Connection connection, OracleTable table,
    ...
    OraOopOracleQueries.setStringAtName(statement, "table_owner",
                                        table.getSchema());
    OraOopOracleQueries.setStringAtName(statement, "table_name",
                                        table.getName());
    ...
    while (resultSet.next()) {
      OraOopOracleDataChunkPartition dataChunk =
          new OraOopOracleDataChunkPartition(
  ...
  public static List<OraOopOracleDataChunkExtent>
  getOracleDataChunksExtent(Configuration conf, Connection connection,
                            OracleTable table, List<String> partitionList,
    ...
    if (partitionList != null && partitionList.size() > 0) {
      sql += " AND case when o.object_type='TABLE SUBPARTITION' then "
    ...
    OraOopOracleQueries.setStringAtName(statement, "object_name",
                                        table.getName());
    ...
    trace(String.format(
        ...
        sql.replace(":numchunks",
                    Integer.toString(numberOfChunksPerOracleDataFile))
    ...
    while (resultSet.next()) {
      ...
      OraOopOracleDataChunkExtent dataChunk = new OraOopOracleDataChunkExtent(
          dataChunkId, resultSet.getInt("data_object_id"),
          resultSet.getInt("relative_fno"), resultSet.getLong("start_block_id"),
          resultSet.getLong("end_block_id"));
      result.add(dataChunk);
    }
  ...
  private static void trace(String message) { LOG.debug(message); }
  ...
  public static String getOracleObjectType(Connection connection,
    ...
    PreparedStatement statement =
        connection.prepareStatement("SELECT object_type "
                                    + " FROM dba_objects"
                                    + " WHERE owner = ?"
                                    + " and object_name = ?");
    statement.setString(1, table.getSchema());
  ...
  public static OracleVersion getOracleVersion(Connection connection)
    ...
    resultSet.next();
    OracleVersion result = new OracleVersion(
        resultSet.getInt("major"), resultSet.getInt("minor"),
        resultSet.getInt("version"), resultSet.getInt("patch"),
  ...
  public static List<OracleTable> getTables(Connection connection, String owner)
      throws SQLException {
  ...
  getTablesWithTableNameLike(Connection connection, String owner,
                             String tableNameLike) throws SQLException {

    return getTables(connection, owner, tableNameLike, TableNameQueryType.Like);
  }

  private static List<OracleTable>
  getTables(Connection connection, String owner, String tableName,
    ...
    String sql = "SELECT owner, table_name "
                 + " FROM dba_tables"
                 + " %s %s %s %s "
    ...
    sql = String.format(sql, options.isEmpty() ? "" : "WHERE",
                        options.contains(GetTablesOptions.Owner) ? "owner = ?"
                                                                 : "",
                        options.containsAll(EnumSet.of(GetTablesOptions.Owner,
                                                       GetTablesOptions.Table))
                            ? "AND"
                            : "",
                        options.contains(GetTablesOptions.Table)
                            ? String.format("table_name %s ?", tableComparitor)
                            : "");

    PreparedStatement statement = connection.prepareStatement(sql);

    if (options.containsAll(
            EnumSet.of(GetTablesOptions.Owner, GetTablesOptions.Table))) {
  ...
  public static List<String> getTableColumnNames(Connection connection,
    ...
    OracleTableColumns oracleTableColumns =
        getTableColumns(connection, table, escapingDisabled);
  ...
  getTableColumnNames(Connection connection, OracleTable table,
                      boolean omitLobAndLongColumnsDuringImport,
                      OraOopConstants.Sqoop.Tool sqoopTool,
                      boolean onlyOraOopSupportedTypes,
                      boolean omitOraOopPseudoColumns, boolean escapingDisabled)
      throws SQLException {

    OracleTableColumns oracleTableColumns = getTableColumns(
        connection, table, omitLobAndLongColumnsDuringImport, sqoopTool,
        onlyOraOopSupportedTypes, omitOraOopPseudoColumns, escapingDisabled);
  ...
  private static OracleTableColumns
  getTableColumns(Connection connection, OracleTable table,
                  boolean omitLobColumns, String dataTypesClause,
                  HashSet<String> columnNamesToOmit, boolean escapingDisabled)
      throws SQLException {
    ...
    sql = String.format(
        sql, dataTypesClause == null ? "" : " and " + dataTypesClause);

    LOG.debug(String.format("%s : sql = \n%s",
                            OraOopUtilities.getCurrentMethodName(), sql));
    ...
    while (resultSet.next()) {
      ...
      result.add(
          new OracleTableColumn(columnName, resultSet.getString("data_type")));
    }
    ...
    sql = String.format("SELECT %s FROM %s WHERE 0=1", columnList.toString(),
                        table.toString());
  ...
  public static OracleTableColumns
  getTableColumns(Connection connection, OracleTable table,
                  boolean omitLobAndLongColumnsDuringImport,
                  OraOopConstants.Sqoop.Tool sqoopTool,
                  boolean onlyOraOopSupportedTypes,
    ...
    return getTableColumns(connection, table, omitLobAndLongColumnsDuringImport,
                           dataTypesClause, columnNamesToOmit,
                           escapingDisabled);
  }

  public static List<OracleActiveInstance>
  getOracleActiveInstances(Connection connection) throws SQLException {
  ...
  public static String oraDATEToString(Object date, String format) {
    try {
      ...
      throw new RuntimeException(
          String.format(
              "Unable to convert the oracle.sql.DATE value \"%s\" to text.",
              date.toString()),
          e);
    }
  }
  ...
  public static Object oraDATEFromString(String date, String format) {
    try {
      Method dateMethod = oracleDateClass.getMethod("fromText", String.class,
  ...
  public static boolean isTableAnIndexOrganizedTable(Connection connection,
    ...
    PreparedStatement statement =
        connection.prepareStatement("select iot_type "
                                    + "from dba_tables "
                                    + "where owner = ? "
                                    + "and table_name = ?");
    statement.setString(1, table.getSchema());
  ...
  exchangeSubpartition(Connection connection, OracleTable table,
    ...
    String sql = String.format(
        "ALTER TABLE %s EXCHANGE SUBPARTITION %s WITH TABLE %s WITHOUT VALIDATION",
        table.toString(), subPartitionName, subPartitionTable.toString());
    statement.execute(sql);
    statement.close();
  }

  public static void createExportTableFromTemplate(
    ...
    String sql =
        String.format("CREATE TABLE %s \n"
                      ...
                      newTable.toString(), noLogging ? "NOLOGGING" : "",
  ...
  public static void createExportTableFromTemplateWithPartitioning(
    ...
    String sql = String.format(
        "CREATE TABLE %s \n"
            ...
            + "WHERE 0=1)",
        newTable.toString(), noLogging ? "NOLOGGING" : "", tableStorageClause,
  ...
  public static void createExportTableForMapper(
      Connection connection, OracleTable table, String tableStorageClause,
      OracleTable templateTable, boolean addOraOopPartitionColumns)
      throws SQLException {
  ...
  public static void createMoreExportTablePartitions(
      Connection connection, OracleTable table, String partitionName,
      Object jobDateTime, String[] subPartitionNames) throws SQLException {
    ...
    String sql =
        String.format("ALTER TABLE %s "
                          ...
                          + "VALUES LESS THAN (to_date('%s', '%s'))"
                          + "( %s ) ",
                      table.toString(), partitionName, partitionBoundStr,
                      dateFormat, subPartitions.toString());
  ...
  public static void
  mergeTable(Connection connection, OracleTable targetTable,
             OracleTable sourceTable, String[] mergeColumnNames,
             OracleTableColumns oracleTableColumns, Object oraOopSysDate,
             int oraOopMapperId, boolean parallelizationEnabled)
      throws SQLException {
    ...
    String sql = String.format(
        "MERGE %7$s INTO %1$s target \n"
            ...
            + "  INSERT (%5$s) \n"
            + "  VALUES (%6$s)",
        targetTable.toString(), sourceTable.toString(),
        generateUpdateKeyColumnsWhereClauseFragment(mergeColumnNames, "target",
                                                    "source"),
        updateClause.toString(), insertClause.toString(), sourceClause,
  ...
  public static void updateTable(Connection connection, OracleTable targetTable,
                                 OracleTable sourceTable,
                                 String[] mergeColumnNames,
                                 OracleTableColumns oracleTableColumns,
                                 Object oraOopSysDate, int oraOopMapperId,
                                 boolean parallelizationEnabled,
                                 boolean escapingDisabled) throws SQLException {
    ...
    for (int idx = 0; idx < oracleTableColumns.size(); idx++) {
      ...
      targetColumnsClause.append(String.format(
          "a.%s", OracleUtils.escapeIdentifier(columnName, escapingDisabled)));

      if (sourceColumnsClause.length() > 0) {
        sourceColumnsClause.append(",");
      }
      sourceColumnsClause.append(String.format(
          "b.%s", OracleUtils.escapeIdentifier(columnName, escapingDisabled)));
    }

    String sourceClause = sourceColumnsClause.toString();

    sourceClause = sourceClause.replaceAll(
        OraOopConstants.COLUMN_NAME_EXPORT_PARTITION,
        String.format("to_date('%s', 'yyyy/mm/dd hh24:mi:ss')",
                      OraOopOracleQueries.oraDATEToString(
                          oraOopSysDate, "yyyy/mm/dd hh24:mi:ss")));

    sourceClause =
        sourceClause.replaceAll(OraOopConstants.COLUMN_NAME_EXPORT_SUBPARTITION,
    ...
    String sql = String.format(
        "UPDATE %5$s %1$s a \n"
            ...
            + "WHERE %7$s)",
        targetTable.toString(), targetColumnsClause.toString(), sourceClause,
        sourceTable.toString(), parallelizationEnabled ? "/*+ parallel */" : "",
        generateUpdateKeyColumnsWhereClauseFragment(mergeColumnNames, "b", "a"),
        generateUpdateKeyColumnsWhereClauseFragment(mergeColumnNames, "c",
                                                    "a"));
  ...
  public static int createExportChangesTable(
      Connection connection, OracleTable tableToCreate,
      String tableToCreateStorageClause, OracleTable tableContainingUpdates,
      OracleTable tableToBeUpdated, String[] joinColumnNames,
      CreateExportChangesTableOptions options, boolean parallelizationEnabled,
      boolean escapingDisabled) throws SQLException {

    List<String> columnNames = getTableColumnNames(
        connection, tableToBeUpdated,
        false // <- omitLobAndLongColumnsDuringImport
        ,
        OraOopConstants.Sqoop.Tool.EXPORT, true // <- onlyOraOopSupportedTypes
        ,
    ...
    for (int idx = 0; idx < columnNames.size(); idx++) {
      ...
      columnClause.append(
          String.format("a.%s", OracleUtils.escapeIdentifier(
                                    columnNames.get(idx), escapingDisabled)));
    }
    ...
    for (int idx = 0; idx < columnNames.size(); idx++) {
      ...
      rowEqualityClause.append(String.format(
          "(a.\"%1$s\" <> b.\"%1$s\" "
    ...
    default:
      throw new RuntimeException(String.format(
          "Update %s to cater for the option \"%s\".",
          OraOopUtilities.getCurrentMethodName(), options.toString()));
    }
    ...
    String sql = String.format(
        "CREATE TABLE %1$s \n"
            ...
            + "%6$s \n"
            + ")",
        tableToCreate.toString(), tableContainingUpdates.toString(),
        tableToBeUpdated.toString(),
        generateUpdateKeyColumnsWhereClauseFragment(joinColumnNames, "a", "b",
                                                    sqlJoin),
        columnClause.toString(), rowEqualityClause.toString(),
        parallelizationEnabled ? "PARALLEL" : "", tableToCreateStorageClause);
    ...
    LOG.info(
        String.format("Time spent creating change-table: %f sec.", timeInSec));

    String indexName = tableToCreate.toString().replaceAll("CHG", "IDX");
    start = System.nanoTime();
    statement.execute(String.format(
        "CREATE INDEX %s ON %s (%s)", indexName, tableToCreate.toString(),
    ...
    ResultSet resultSet = statement.executeQuery(
        String.format("select count(*) from %s", tableToCreate.toString()));
    resultSet.next();
  ...
  public static void
  deleteRowsFromTable(Connection connection, OracleTable tableToDeleteRowsFrom,
                      OracleTable tableContainingRowsToDelete,
                      String[] joinColumnNames, boolean parallelizationEnabled)
      throws SQLException {

    String sql = String.format(
        "DELETE %4$s FROM %1$s a \n"
            + "WHERE EXISTS ( \n"
  ...
  public static void insertRowsIntoExportTable(
      Connection connection, OracleTable tableToInsertRowsInto,
      OracleTable tableContainingRowsToInsert, Object oraOopSysDate,
      int oraOopMapperId, boolean parallelizationEnabled,
      boolean escapingDisabled) throws SQLException {

    List<String> columnNames = getTableColumnNames(
        connection, tableToInsertRowsInto, escapingDisabled);
    ...
    String sql =
        String.format("insert %4$s \n"
                          ...
                          + "%2$s \n"
                          + "from %3$s",
                      tableToInsertRowsInto.toString(), columnsClause,
  ...
  generateUpdateKeyColumnsWhereClauseFragment(String[] joinColumnNames,
                                              String prefix1, String prefix2) {

    return generateUpdateKeyColumnsWhereClauseFragment(joinColumnNames, prefix1,
                                                       prefix2, "");
  }
  ...
  public static void setLongAtName(PreparedStatement statement, String bindName,
                                   long bindValue) throws SQLException {
    try {
  ...
  public static void setBigDecimalAtName(PreparedStatement statement,
                                         String bindName, BigDecimal bindValue)
      throws SQLException {
    try {
  ...
  public static void setStringAtName(PreparedStatement statement,
                                     String bindName, String bindValue)
      throws SQLException {
    try {
  ...
  public static void setTimestampAtName(PreparedStatement statement,
                                        String bindName, Timestamp bindValue)
      throws SQLException {
    try {
  ...
  public static void setBinaryDoubleAtName(PreparedStatement statement,
                                           String bindName, double bindValue)
      throws SQLException {
    try {
  ...
  public static void setObjectAtName(PreparedStatement statement,
                                     String bindName, Object bindValue)
      throws SQLException {
    try {
  ...
  public static void setBinaryFloatAtName(PreparedStatement statement,
                                          String bindName, float bindValue)
      throws SQLException {
    try {
