...
public class GenericJdbcManager extends SqlManager {
  ...
  public static final Log LOG =
      LogFactory.getLog(GenericJdbcManager.class.getName());
  ...
  protected boolean hasOpenConnection() { return this.connection != null; }
  ...
  public String getDriverClass() { return jdbcDriverClass; }

  public String parseExtraScheArgs(String[] args, RelatedOptions opts)
