...
public final class ConfigurationHelper {
  ...
  public static long getNumMapOutputRecords(Job job)
    ...
    return job.getCounters()
        .findCounter(ConfigurationConstants.COUNTER_GROUP_MAPRED_TASK_COUNTERS,
  ...
  public static long getNumMapInputRecords(Job job)
    ...
    return job.getCounters()
        .findCounter(ConfigurationConstants.COUNTER_GROUP_MAPRED_TASK_COUNTERS,
                     ConfigurationConstants.COUNTER_MAP_INPUT_RECORDS)
        .getValue();
  }
  ...
  public static <U> List<U> getInstances(Configuration conf, String name,
                                         Class<U> xface) {
  ...
  public static Integer getIntegerConfigIfExists(Configuration conf,
                                                 String key) {
    Integer config = null;
