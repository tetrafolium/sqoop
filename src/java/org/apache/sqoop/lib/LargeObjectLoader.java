...
public static final Log LOG =
	LogFactory.getLog(LargeObjectLoader.class.getName());
...
throws IOException, InterruptedException, SQLException {
	...
	long maxInlineLobLen =
		conf.getLong(MAX_INLINE_LOB_LEN_KEY, DEFAULT_MAX_LOB_LENGTH);
	...
	if (null == b) {
		...
		return new org.apache.sqoop.lib.BlobRef(getRelativePath(curBlobWriter),
		                                        recordOffset, len);
	} else {
		// This is a 1-based array.
		return new org.apache.sqoop.lib.BlobRef(b.getBytes(1, (int)b.length()));
	}
}
...
throws IOException, InterruptedException, SQLException {
	...
	if (null == c) {
		...
		return new org.apache.sqoop.lib.ClobRef(getRelativePath(lobWriter),
		                                        recordOffset, len);
	} else {
		// This is a 1-based array.
