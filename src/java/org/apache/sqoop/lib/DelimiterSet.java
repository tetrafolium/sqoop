...
public class DelimiterSet implements Cloneable {
  ...
  public String toString() {
    return "fields=" + this.fieldDelim + " records=" + this.recordDelim +
        " escape=" + this.escapedBy + " enclose=" + this.enclosedBy +
  ...
  public String formatConstructor() {
    return "new DelimiterSet((char) " + (int)this.fieldDelim + ", "
        ...
        + "(char) " + (int)this.escapedBy + ", " + this.encloseRequired + ")";
  }
   ...
   */
  public int hashCode() {
    return (int)this.fieldDelim + (((int)this.recordDelim) << 4) +
        (((int)this.escapedBy) << 8) + (((int)this.enclosedBy) << 12) +
  ...
  public boolean equals(Object other) {
    ...
    return this.fieldDelim == set.fieldDelim &&
        ...
        this.escapedBy == set.escapedBy && this.enclosedBy == set.enclosedBy &&
