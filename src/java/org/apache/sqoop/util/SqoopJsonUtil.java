...
public class SqoopJsonUtil {
  ...
  public static final Log LOG =
      LogFactory.getLog(SqoopJsonUtil.class.getName());
    ...
    try {
      if (isEmptyJSON(mapJsonStr)) {
        ...
        result = mapper.readValue(
            mapJsonStr, new TypeReference<HashMap<String, String>>() {});
      }
      return result;
      ...
      throw new IllegalArgumentException(
          "Illegal json to parse into map :" + mapJsonStr + e.getMessage(), e);
