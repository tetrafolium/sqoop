...
public final class CredentialsUtil {
   ...
   */
  private static String PROPERTY_LOADER_CLASSS =
      "org.apache.sqoop.credentials.loader.class";

  /**
   * The default loader is a FilePasswordLoader that will fetch the password
   * from a file.
   */
  private static String DEFAULT_PASSWORD_LOADER =
      FilePasswordLoader.class.getCanonicalName();

  public static final Log LOG =
      LogFactory.getLog(CredentialsUtil.class.getName());

  private CredentialsUtil() {}

  /**
   * Return password that was specified (either on command line or via other
   * facilities).
   *
  ...
  public static String fetchPassword(SqoopOptions options) throws IOException {
    ...
    return fetchPasswordFromLoader(options.getPasswordFilePath(),
                                   options.getConf());
  }
   ...
   * @throws IOException
   */
  public static String fetchPasswordFromLoader(String path, Configuration conf)
      throws IOException {
   ...
   * @throws IOException
   */
  public static void cleanUpSensitiveProperties(Configuration configuration)
      throws IOException {
   ...
   * @throws IOException
   */
  public static PasswordLoader getLoader(Configuration configuration)
      throws IOException {
    String loaderClass =
        configuration.get(PROPERTY_LOADER_CLASSS, DEFAULT_PASSWORD_LOADER);
