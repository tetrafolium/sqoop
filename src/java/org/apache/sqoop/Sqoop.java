...
public class Sqoop extends Configured implements Tool {
   ...
   */
  public Sqoop(SqoopTool tool) { this(tool, (Configuration)null); }
   ...
   */
  public SqoopOptions getOptions() { return this.options; }

  /**
   * @return the SqoopTool used in this Sqoop instance.
   */
  public SqoopTool getTool() { return this.tool; }
  ...
  public static void rethrowIfRequired(String[] toolArgs, Exception ex) {
    if (!isSqoopRethrowSystemPropertySet() &&
