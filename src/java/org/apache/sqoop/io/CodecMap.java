...
public final class CodecMap {
  ...
  public static CompressionCodec getCodec(String codecName, Configuration conf)
    ...
    try {
      ...
      Class<? extends CompressionCodec> codecClass =
          (Class<? extends CompressionCodec>)conf.getClassByName(
              codecClassName);
      ...
      throw new org.apache.sqoop.io.UnsupportedCodecException(
          "Cannot find codec class " + codecClassName + " for codec " +
          codecName);
    }
  }
   ...
   */
  public static Set<String> getCodecNames() { return codecNames.keySet(); }
