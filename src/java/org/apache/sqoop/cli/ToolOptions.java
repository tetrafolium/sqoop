...
public class ToolOptions implements Iterable<RelatedOptions> {
  ...
  public ToolOptions() { this.optGroups = new ArrayList<RelatedOptions>(); }

  /**
   * Add a block of related options to the options for this tool.
   * @param opts the set of RelatedOptions to add.
   */
  public void addOptions(RelatedOptions opts) { optGroups.add(opts); }
   ...
   */
  public Iterator<RelatedOptions> iterator() { return optGroups.iterator(); }
   ...
   */
  public void printHelp() { printHelp(new HelpFormatter()); }
