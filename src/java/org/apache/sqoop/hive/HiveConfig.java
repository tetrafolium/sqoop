...
public static final String HIVE_CONF_CLASS =
...
throws IOException {
	try {
		...
		return (
			(Configuration)(HiveConfClass
			                .getConstructor(Configuration.class, Class.class)
...
/**
 * Add hive conf to configuration object without overriding already set
 * properties.
 * @param hiveConf
 * @param conf
 */
public static void addHiveConfigs(Configuration hiveConf,
                                  Configuration conf) {
