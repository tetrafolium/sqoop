...
public class HiveImport implements HiveClient {
  ...
  public HiveImport(final SqoopOptions opts, final ConnManager connMgr,
                    ...
                    final HiveClientCommon hiveClientCommon) {
    this.options = opts;
  ...
  public HiveImport(SqoopOptions opts, ConnManager connMgr, Configuration conf,
   ...
   */
  boolean isGenerateOnly() { return generateOnly; }
  ...
  public void importTable(String inputTableName, String outputTableName,
    ...
    TableDefWriter tableWriter =
        new TableDefWriter(options, connManager, inputTableName,
                           outputTableName, configuration, !debugMode);
  ...
  private String[] getHiveArgs(String... args) throws IOException {
    ...
    HiveConfig.addHiveConfigs(HiveConfig.getHiveConf(configuration),
                              configuration);
  ...
  SqoopOptions getOptions() { return options; }

  ConnManager getConnManager() { return connManager; }
