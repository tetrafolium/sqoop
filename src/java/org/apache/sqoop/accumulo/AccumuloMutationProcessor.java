...
public class AccumuloMutationProcessor
  ...
  public void setConf(Configuration config) {
    ...
    Class<? extends MutationTransformer> xformerClass =
        (Class<? extends MutationTransformer>)this.conf.getClass(
            AccumuloConstants.TRANSFORMER_CLASS_KEY,
            ToStringMutationTransformer.class);
    this.mutationTransformer = (MutationTransformer)ReflectionUtils.newInstance(
        xformerClass, this.conf);
    ...
    try {
      ...
      throw new RuntimeException("Accumulo table " + tableName + " not found",
                                 tex);
    }
  }
