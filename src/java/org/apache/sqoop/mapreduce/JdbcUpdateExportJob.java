...
public class JdbcUpdateExportJob extends ExportJobBase {
  ...
  public static final Log LOG =
      LogFactory.getLog(JdbcUpdateExportJob.class.getName());
  ...
  protected void configureOutputFormat(Job job, String tableName,
    ...
    try {
      ...
      DBOutputFormat.setOutput(job, mgr.escapeTableName(tableName),
                               mgr.escapeColNames(outColNames));
  ...
  private void configureGenericRecordExportInputFormat(Job job,
    ...
    for (Map.Entry<String, Integer> e : columnTypeInts.entrySet()) {
      ...
      Text columnText =
          new Text(connManager.toJavaType(tableName, e.getKey(), e.getValue()));
