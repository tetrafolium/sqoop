...
public class MainframeImportJob extends DataDrivenImportJob {
  ...
  private static final Log LOG =
      LogFactory.getLog(MainframeImportJob.class.getName());

  public MainframeImportJob(
      final SqoopOptions opts, ImportJobContext context,
      ParquetImportJobConfigurator parquetImportJobConfigurator) {
  ...
  protected void configureMapper(Job job, String tableName,
    ...
    if (SqoopOptions.FileLayout.BinaryFile == options.getFileLayout()) {
      ...
      // this is required as code generated class assumes setField method takes
      // String and will fail with ClassCastException when a byte array is
      // passed instead java.lang.ClassCastException: [B cannot be cast to
      // java.lang.String
      Configuration conf = job.getConfiguration();
      conf.setClass(
          org.apache.sqoop.mapreduce.db.DBConfiguration.INPUT_CLASS_PROPERTY,
          MainframeDatasetBinaryRecord.class, DBWritable.class);
    }
  }
  ...
  protected Class<? extends OutputFormat> getOutputFormatClass() {
    ...
    } else if (options.getFileLayout() == SqoopOptions.FileLayout.BinaryFile) {
