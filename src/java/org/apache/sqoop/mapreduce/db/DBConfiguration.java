...
public class DBConfiguration {
  ...
  private static void setPassword(JobConf configuration, String password) {
    ...
    configuration.getCredentials().addSecretKey(PASSWORD_SECRET_KEY,
                                                password.getBytes());
  }
  ...
  public DBConfiguration(Configuration job) { this.conf = job; }
  ...
  public static String getPassword(JobConf configuration) {
    ...
    byte[] secret =
        configuration.getCredentials().getSecretKey(PASSWORD_SECRET_KEY);
