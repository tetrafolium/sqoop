...
public static final Log LOG =
	LogFactory.getLog(HBaseImportJob.class.getName());
...
throws ClassNotFoundException, IOException {
	...
	conf.set(HBasePutProcessor.NULL_INCREMENTAL_MODE,
	         options.getHbaseNullIncrementalMode().toString());
...
protected void jobSetup(Job job) throws IOException, ImportException {
	...
	Method m = null;
	try {
		m = HBaseConfiguration.class.getMethod("merge", Configuration.class,
		                                       Configuration.class);
