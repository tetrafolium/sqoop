...
public class JdbcCallExportJob extends JdbcExportJob {
  ...
  public static final Log LOG =
      LogFactory.getLog(JdbcCallExportJob.class.getName());
  ...
  protected void configureOutputFormat(Job job, String tableName,
    ...
    try {
      if (Strings.isNullOrEmpty(options.getUsername())) {
        ...
        DBConfiguration.configureDB(
            job.getConfiguration(), mgr.getDriverClass(),
            options.getConnectString(), options.getUsername(),
      ...
      DBOutputFormat.setOutput(job, mgr.escapeTableName(procedureName),
