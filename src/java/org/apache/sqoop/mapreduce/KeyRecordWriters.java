...
public class KeyRecordWriters {
  ...
  public static class GenericRecordWriter<K, V> extends RecordWriter<K, V> {
    ...
    @Override
    public synchronized void close(TaskAttemptContext taskAttemptContext)
        throws IOException, InterruptedException {
      out.close();
    }
  }
  ...
  public static class RawKeyRecordWriter<K, V>
    ...
    public RawKeyRecordWriter(DataOutputStream out) { this.out = out; }
  }
  ...
  public static class BinaryKeyRecordWriter<K, V>
    ...
    public BinaryKeyRecordWriter(DataOutputStream out) { this.out = out; }
