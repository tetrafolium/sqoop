...
public abstract class AsyncSqlOutputFormat<K extends SqoopRecord, V>
  ...
  public static class AsyncDBOperation {
     ...
     * operation.
     */
    public AsyncDBOperation(PreparedStatement s, boolean batch, boolean commit,
                            boolean stopThread) {
      this.stmt = s;
      this.isBatch = batch;
      this.commit = commit;
     ...
     */
    public boolean requiresCommit() { return this.commit; }

    /**
     * @return true if the executor should stop after this command.
     */
    public boolean stop() { return this.stopThread; }

    /**
     * @return true if this is a batch SQL statement.
     */
    public boolean execAsBatch() { return this.isBatch; }
  }
