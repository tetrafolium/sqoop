...
public class SqoopHCatExportFormat extends HCatInputFormat {
  public static final Log LOG =
      LogFactory.getLog(SqoopHCatExportFormat.class.getName());
  ...
  public List<InputSplit> getSplits(JobContext job)
    ...
    for (int i = 0; i < hCatSplitCount; ++i) {
      ...
      if (ascendingAssigment) {
        ...
        combinedSplitList.get(expectedSplitCount - 1 - splitNum)
            .add(hCatSplits.get(i));
      }
      lastSet = currentSet;
    }
    for (int i = 0; i < expectedSplitCount; i++) {
  ...
  public RecordReader<WritableComparable, HCatRecord>
  createHCatRecordReader(InputSplit split, TaskAttemptContext taskContext)
      throws IOException, InterruptedException {
