...
public class SQLServerResilientExportOutputFormat<K extends SqoopRecord, V>
  ...
  private static final Log LOG =
      LogFactory.getLog(SQLServerResilientExportOutputFormat.class);
  ...
  public class SQLServerExportRecordWriter<K extends SqoopRecord, V>
    ...
    private final Log LOG =
        LogFactory.getLog(SQLServerExportRecordWriter.class);
    ...
    protected List<List<SqoopRecord>> recordsLists =
        new ArrayList<List<SqoopRecord>>();
