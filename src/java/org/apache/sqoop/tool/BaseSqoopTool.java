...
public abstract class BaseSqoopTool extends org.apache.sqoop.tool.SqoopTool {
  ...
  public static final Log LOG =
      LogFactory.getLog(BaseSqoopTool.class.getName());
  ...
  public static final String HIVE_EXTERNAL_TABLE_LOCATION_ARG =
      "external-table-dir";
  ...
  public static final String HCATALOG_EXTERNAL_TABLE_ARG =
  ...
  public static final String ESCAPE_MAPPING_COLUMN_NAMES_ENABLED =
      "escape-mapping-column-names";
  public static final String PARQUET_CONFIGURATOR_IMPLEMENTATION =
  ...
  public static final String HBASE_NULL_INCREMENTAL_MODE_ARG =
  ...
  static final String HIVE_IMPORT_WITH_LASTMODIFIED_NOT_SUPPORTED =
      "--incremental lastmodified option for hive imports is not "
      + "supported. Please remove the parameter --incremental lastmodified.";

  public BaseSqoopTool() {}

  public BaseSqoopTool(String toolName) { super(toolName); }

  protected ConnManager manager;

  public ConnManager getManager() { return manager; }

  public void setManager(ConnManager mgr) { this.manager = mgr; }
  ...
  protected RelatedOptions getJobOptions() {
    ...
    relatedOpts.addOption(
        OptionBuilder.withArgName("jdbc-uri")
            ...
            .create());
    relatedOpts.addOption(
        OptionBuilder.withArgName("metastore-db-username")
            .hasArg()
            .withDescription("Specify the username string for the metastore")
            .withLongOpt(METASTORE_USER_ARG)
            .create());
    relatedOpts.addOption(
        OptionBuilder.withArgName("metastore-db-password")
            .hasArg()
    ...
    group.addOption(OptionBuilder.withDescription("List saved jobs")
  ...
  protected RelatedOptions getCommonOptions() {
    ...
    commonOpts.addOption(
        OptionBuilder.withArgName(PASSWORD_ALIAS_ARG)
            .hasArg()
            .withDescription("Credential provider password alias")
            .withLongOpt(PASSWORD_ALIAS_ARG)
            .create());
    commonOpts.addOption(
        OptionBuilder.withArgName("dir")
            .hasArg()
            .withDescription("Override $HADOOP_MAPRED_HOME_ARG")
    ...
    commonOpts.addOption(
        OptionBuilder
            .withDescription(
                "Defines the temporary root directory for the import")
    ...
    commonOpts.addOption(
        OptionBuilder
            .withDescription(
                "Rethrow a RuntimeException on error occurred during the job")
    ...
    commonOpts.addOption(
        OptionBuilder.hasArg()
            .withDescription(
                "The implementation used during Parquet reading/writing")
  ...
  protected RelatedOptions getHiveOptions(boolean explicitHiveImport) {
    ...
    hiveOpts.addOption(OptionBuilder.withArgName("dir")
                           .hasArg()
                           .withDescription("Override $HIVE_HOME")
    ...
    hiveOpts.addOption(
        OptionBuilder.hasArg()
            .withDescription(
                "The location of the keytab of the HiveServer2 user.")
  ...
  protected RelatedOptions getHCatalogOptions() {
    ...
    hCatOptions.addOption(OptionBuilder.hasArg()
    ...
    hCatOptions.addOption(
        OptionBuilder
            .withDescription(
                "Signing that HCatalog table shall be created as external")
    ...
    hCatOptions.addOption(OptionBuilder.withArgName("hdir")
                              .hasArg()
                              .withDescription("Override $HCAT_HOME")
    ...
    hCatOptions.addOption(
        OptionBuilder.withArgName("partition-key")
            .hasArg()
            .withDescription(
                "Sets the partition keys to use when importing to hive")
  ...
  protected RelatedOptions getHCatImportOnlyOptions() {
    RelatedOptions hCatOptions =
        new RelatedOptions("HCatalog import specific options");
    hCatOptions.addOption(
  ...
  protected RelatedOptions getOutputFormatOptions() {
    RelatedOptions formatOpts =
        new RelatedOptions("Output line formatting arguments");
  ...
  protected RelatedOptions getCodeGenOpts(boolean multiTable) {
    ...
    codeGenOpts.addOption(
        OptionBuilder.withArgName("dir")
            ...
            .create());
    codeGenOpts.addOption(
        OptionBuilder.withDescription("Delete compile directory")
    ...
    codeGenOpts.addOption(
        OptionBuilder.hasArg()
            .withDescription(
                "Disable special characters escaping in column names")
  ...
  protected RelatedOptions getHBaseOptions() {
    ...
    hbaseOpts.addOption(
        OptionBuilder
            ...
            .create());
    hbaseOpts.addOption(
        OptionBuilder.withArgName("nullmode")
            .hasArg()
            .withDescription(
                "How to handle null values during incremental import into HBase.")
  ...
  protected RelatedOptions getAccumuloOptions() {
    ...
    accumuloOpts.addOption(
        OptionBuilder.withArgName("vis")
            .hasArg()
            .withDescription(
                "Visibility token to be applied to all rows imported")
  ...
  protected void applyAccumuloOptions(CommandLine in, SqoopOptions out) {
    ...
    if (in.hasOption(ACCUMULO_BATCH_SIZE_ARG)) {
      out.setAccumuloBatchSize(
          Long.parseLong(in.getOptionValue(ACCUMULO_BATCH_SIZE_ARG)));
    }

    if (in.hasOption(ACCUMULO_MAX_LATENCY_ARG)) {
      out.setAccumuloMaxLatency(
          Long.parseLong(in.getOptionValue(ACCUMULO_MAX_LATENCY_ARG)));
    }
  ...
  protected void addValidationOpts(RelatedOptions validationOptions) {
    ...
    validationOptions.addOption(
        OptionBuilder.withArgName(VALIDATION_THRESHOLD_CLASS_ARG)
            .hasArg()
            .withDescription(
                "Fully qualified class name for ValidationThreshold")
  ...
  protected void applyCommonOptions(CommandLine in, SqoopOptions out)
    ...
    if (in.hasOption(METADATA_TRANSACTION_ISOLATION_LEVEL)) {
      ...
      try {
        out.setMetadataTransactionIsolationLevel(
            JDBCTransactionLevels.valueOf(transactionLevel)
                .getTransactionIsolationLevelValue());
      } catch (IllegalArgumentException e) {
        throw new RuntimeException(
            "Only transaction isolation levels defined by "
                + "java.sql.Connection class are supported. Check the "
                + "java.sql.Connection javadocs for more details",
            e);
      }
    }

    if (in.hasOption(ORACLE_ESCAPING_DISABLED)) {
      out.setOracleEscapingDisabled(
          Boolean.parseBoolean(in.getOptionValue(ORACLE_ESCAPING_DISABLED)));
    }

    if (in.hasOption(ESCAPE_MAPPING_COLUMN_NAMES_ENABLED)) {
      out.setEscapeMappingColumnNamesEnabled(Boolean.parseBoolean(
          in.getOptionValue(ESCAPE_MAPPING_COLUMN_NAMES_ENABLED)));
    }
  ...
  private void applyCredentialsOptions(CommandLine in, SqoopOptions out)
    ...
    if (in.hasOption(PASSWORD_PATH_ARG)) {
      ...
      try {
        ...
        throw(InvalidOptionsException) new InvalidOptionsException(
            "Error while loading password file: " + ex.getMessage())
            .initCause(ex);
      }
    }
    if (in.hasOption(PASSWORD_ALIAS_ARG)) {
      ...
      try {
        out.setPassword(CredentialProviderHelper.resolveAlias(
            out.getConf(), in.getOptionValue(PASSWORD_ALIAS_ARG)));
  ...
  protected void applyHiveOptions(CommandLine in, SqoopOptions out)
    ...
    if (in.hasOption(HIVE_EXTERNAL_TABLE_LOCATION_ARG)) {
      out.setHiveExternalTableDir(
          in.getOptionValue(HIVE_EXTERNAL_TABLE_LOCATION_ARG));
    }
  ...
  protected void applyOutputFormatOptions(CommandLine in, SqoopOptions out)
    ...
    if (in.hasOption(FIELDS_TERMINATED_BY_ARG)) {
      out.setFieldsTerminatedBy(
          SqoopOptions.toChar(in.getOptionValue(FIELDS_TERMINATED_BY_ARG)));
      out.setExplicitOutputDelims(true);
    }

    if (in.hasOption(LINES_TERMINATED_BY_ARG)) {
      out.setLinesTerminatedBy(
          SqoopOptions.toChar(in.getOptionValue(LINES_TERMINATED_BY_ARG)));
      out.setExplicitOutputDelims(true);
    }

    if (in.hasOption(OPTIONALLY_ENCLOSED_BY_ARG)) {
      out.setEnclosedBy(
          SqoopOptions.toChar(in.getOptionValue(OPTIONALLY_ENCLOSED_BY_ARG)));
    ...
    if (in.hasOption(ENCLOSED_BY_ARG)) {
      out.setEnclosedBy(
          SqoopOptions.toChar(in.getOptionValue(ENCLOSED_BY_ARG)));
  ...
  protected void applyInputFormatOptions(CommandLine in, SqoopOptions out)
    ...
    if (in.hasOption(INPUT_ENCLOSED_BY_ARG)) {
      out.setInputEnclosedBy(
          SqoopOptions.toChar(in.getOptionValue(INPUT_ENCLOSED_BY_ARG)));
      out.setInputEncloseRequired(true);
      out.setExplicitInputDelims(true);
    }

    if (in.hasOption(INPUT_ESCAPED_BY_ARG)) {
      out.setInputEscapedBy(
          SqoopOptions.toChar(in.getOptionValue(INPUT_ESCAPED_BY_ARG)));
      out.setExplicitInputDelims(true);
    }
  }
  ...
  protected void applyHBaseOptions(CommandLine in, SqoopOptions out)
    ...
    if (in.hasOption(HBASE_NULL_INCREMENTAL_MODE_ARG)) {
      ...
      if ("ignore".equals(nullMode)) {
        out.setHbaseNullIncrementalMode(
            SqoopOptions.HBaseNullIncrementalMode.Ignore);
      } else if ("delete".equals(nullMode)) {
        out.setHbaseNullIncrementalMode(
            SqoopOptions.HBaseNullIncrementalMode.Delete);
      } else {
        throw new InvalidOptionsException(
            "Unknown HBase null incremental mode: " + nullMode +
            ". Use 'ignore' or 'delete'." + HELP_STR);
      }
    }
  }
  ...
  protected void validateCommonOptions(SqoopOptions options)
    ...
    if (options.getConnectString() == null) {
      throw new InvalidOptionsException(
          "Error: Required argument --connect is missing." + HELP_STR);
    }
  }
  ...
  protected void validateHiveOptions(SqoopOptions options)
    ...
    if (options.getHiveDelimsReplacement() != null &&
      ...
      throw new InvalidOptionsException(
          "The " + HIVE_DROP_DELIMS_ARG + " option conflicts with the " +
    ...
    if (hCatTable != null && options.doHiveImport()) {
      throw new InvalidOptionsException(
          "The " + HCATALOG_TABLE_ARG + " option conflicts with the " +
          HIVE_IMPORT_ARG + " option." + HELP_STR);
    }

    if (options.isHCatTableExternal() &&
        !(options.doCreateHCatalogTable() ||
      ...
      throw new InvalidOptionsException(String.format(
          ...
          HCATALOG_EXTERNAL_TABLE_ARG, CREATE_HCATALOG_TABLE_ARG,
    ...
    if (!options.doHiveImport() &&
        (((options.getHiveHome() != null &&
           ...
           hCatTable == null)) ||
         options.doOverwriteHiveTable() || options.doFailIfHiveTableExists() ||
    ...
    Boolean isNotHiveImportButExternalTableDirIsSet =
        !options.doHiveImport() && !org.apache.commons.lang.StringUtils.isBlank(
                                       options.getHiveExternalTableDir());
    if (isNotHiveImportButExternalTableDirIsSet) {
      LOG.warn(
          "Importing to external Hive table requires --hive-import parameter to be set");
      throw new InvalidOptionsException(
          "Importing to external Hive table requires --hive-import parameter to be set." +
          HELP_STR);
    }
  ...
  protected void validateHCatalogOptions(SqoopOptions options)
    ...
    String hCatTable = options.getHCatTableName();
    if (hCatTable == null) {
      if (options.getHCatHome() != null &&
          !options.getHCatHome().equals(SqoopOptions.getHCatHomeDefault())) {
    ...
    if (isSet(options.getHCatTableName()) &&
        SqoopHCatUtilities.isHCatView(options)) {
      throw new InvalidOptionsException(
    ...
    if (options.explicitInputDelims()) {
      LOG.warn(
          "Input field/record delimiter options are not "
    ...
    if (options.explicitOutputDelims() ||
        ...
        options.doHiveDropDelims()) {
      LOG.warn(
          "Output field/record delimiter options are not useful"
    ...
    if (options.getTargetDir() != null) {
      throw new InvalidOptionsException(
          "The " + TARGET_DIR_ARG + " option conflicts with the " +
          HCATALOG_TABLE_ARG + " option." + HELP_STR);
    }
    if (options.getWarehouseDir() != null) {
      throw new InvalidOptionsException(
          "The " + WAREHOUSE_DIR_ARG + " option conflicts with the " +
          HCATALOG_TABLE_ARG + " option." + HELP_STR);
    }

    if (options.isAppendMode()) {
      throw new InvalidOptionsException(
          "Append mode for imports is not "
          + " compatible with HCatalog. Please remove the parameter"
          + "--append-mode");
    }
    if (options.getExportDir() != null) {
      throw new InvalidOptionsException(
          "The " + EXPORT_PATH_ARG + " option conflicts with the " +
          HCATALOG_TABLE_ARG + " option." + HELP_STR);
    }
    ...
    if (options.getFileLayout() == SqoopOptions.FileLayout.AvroDataFile) {
      throw new InvalidOptionsException("HCatalog job is not compatible with "
                                        + " AVRO format option " +
                                        FMT_AVRODATAFILE_ARG + " option." +
                                        HELP_STR);
    }

    if (options.getFileLayout() == SqoopOptions.FileLayout.SequenceFile) {
      throw new InvalidOptionsException("HCatalog job  is not compatible with "
                                        + "SequenceFile format option " +
                                        FMT_SEQUENCEFILE_ARG + " option." +
                                        HELP_STR);
    }
    ...
    if (options.getHCatalogPartitionKeys() != null &&
      ...
      throw new InvalidOptionsException(
          "Either both --hcatalog-partition-keys"
          +
    ...
    if (options.getHCatalogPartitionKeys() != null) {
      ...
      if (keys.length != vals.length) {
        throw new InvalidOptionsException(
            "Number of static partition keys "
      ...
      if (options.getHivePartitionKey() != null &&
        ...
        throw new InvalidOptionsException(
            "Either both --hive-partition-key and"
  ...
  protected void validateHBaseOptions(SqoopOptions options)
      throws InvalidOptionsException {
    if ((options.getHBaseColFamily() != null &&
    ...
    if (options.isBulkLoadEnabled() && options.getHBaseTable() == null) {
      String validationMessage =
          String.format("Can't run import with %s "
                            + "without %s",
    ...
    if (options.getHBaseTable() != null &&
        options.getFileLayout() != SqoopOptions.FileLayout.TextFile) {
      String validationMessage =
          String.format("Can't run HBase import with file layout: %s",
  ...
  protected void validateHasDirectConnectorOption(SqoopOptions options)
  ...
  protected void validateHS2Options(SqoopOptions options)
      throws SqoopOptions.InvalidOptionsException {
    final String withoutTemplate =
        "The %s option cannot be used without the %s option.";

    if (isSet(options.getHs2Url()) && !options.doHiveImport()) {
      throw new InvalidOptionsException(
          format(withoutTemplate, HS2_URL_ARG, HIVE_IMPORT_ARG));
    }

    if (isSet(options.getHs2User()) && !isSet(options.getHs2Url())) {
      throw new InvalidOptionsException(
          format(withoutTemplate, HS2_USER_ARG, HS2_URL_ARG));
    }

    if (isSet(options.getHs2Keytab()) && !isSet(options.getHs2User())) {
      throw new InvalidOptionsException(
          format(withoutTemplate, HS2_KEYTAB_ARG, HS2_USER_ARG));
    }
  }

  private void applyParquetJobConfigurationImplementation(CommandLine in,
                                                          SqoopOptions out)
      throws InvalidOptionsException {
    String optionValue = in.getOptionValue(PARQUET_CONFIGURATOR_IMPLEMENTATION);
    String propertyValue =
        out.getConf().get(PARQUET_JOB_CONFIGURATOR_IMPLEMENTATION_KEY);

    String valueToUse = isBlank(optionValue) ? propertyValue : optionValue;

    if (isBlank(valueToUse)) {
      LOG.debug(
          "Parquet job configurator implementation is not set, using default value: " +
          out.getParquetConfiguratorImplementation());
      return;
    }

    try {
      ParquetJobConfiguratorImplementation parquetConfiguratorImplementation =
          valueOf(valueToUse.toUpperCase());
      out.setParquetConfiguratorImplementation(
          parquetConfiguratorImplementation);
      LOG.debug("Parquet job configurator implementation set: " +
                parquetConfiguratorImplementation);
    } catch (IllegalArgumentException e) {
      throw new InvalidOptionsException(format(
          "Invalid Parquet job configurator implementation is set: %s. Supported values are: %s",
          valueToUse,
          Arrays.toString(ParquetJobConfiguratorImplementation.values())));
    }
  }

  public ParquetJobConfiguratorFactory
  getParquetJobConfigurator(SqoopOptions sqoopOptions) {
