...
public class JobTool extends BaseSqoopTool {
  ...
  private int configureChildTool(SqoopOptions childOptions, SqoopTool childTool,
                                 String[] childArgv) {
    ...
    try {
      childOptions = childTool.parseArguments(parseableChildArgv, null,
                                              childOptions, false);
  ...
  private int showJob(SqoopOptions opts) throws IOException {
    ...
    Map<String, String> props =
        PasswordRedactor.redactValues(childOpts.writeProperties());
  ...
  private void initializeStorageDescriptor(SqoopOptions options)
      throws InvalidOptionsException {
  ...
  private void applyMetastoreOptions(CommandLine in, SqoopOptions out)
      throws InvalidOptionsException {
