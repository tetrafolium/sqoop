...
public class CodeGenTool extends BaseSqoopTool {
  ...
  public String generateORM(SqoopOptions options, String tableName)
    ...
    if (tableName != null &&
      ...
      String className =
          options.getClassName() != null ? options.getClassName() : tableName;
    ...
    try {
      ...
      if ((options.doHiveImport()) && (options.getFileLayout() != SqoopOptions.FileLayout.ParquetFile)) {
        HiveImport hiveImport =
            new HiveImport(options, manager, options.getConf(), true);
  ...
  public void validateOptions(SqoopOptions options)
    ...
    if (options.getTableName() == null && options.getSqlQuery() == null) {
      ...
      throw new InvalidOptionsException("Cannot specify --" + TABLE_ARG +
                                        " and --" + SQL_QUERY_ARG +
                                        " together. " + HELP_STR);
    }
  }
