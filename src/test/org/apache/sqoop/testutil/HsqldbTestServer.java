...
public class HsqldbTestServer {
  ...
  private static final String DB_URL =
      "jdbc:hsqldb:" + getServerHost() + DATABASE_NAME;
  ...
  public static String getSchemaName() { return HSQLDB_SCHEMA_NAME; }
  ...
  public static String getTableName() { return DUMMY_TABLE_NAME; }
   ...
   */
  public static int getFirstColSum() { return 1 + 3 + 5 + 7; }
  ...
  public void createNewUser(String username, String password)
    ...
    try (Connection connection = getConnection();
      ...
      statement.executeUpdate(String.format("CREATE USER %s PASSWORD %s ADMIN",
                                            username, password));
    }
  }

  public void changePasswordForUser(String username, String oldPassword,
                                    String newPassword) throws SQLException {
    try (Connection connection = getConnection(username, oldPassword);
         Statement statement = connection.createStatement()) {
      statement.executeUpdate(String.format("ALTER USER %s SET PASSWORD %s",
