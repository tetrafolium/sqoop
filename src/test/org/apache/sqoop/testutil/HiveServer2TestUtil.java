...
public class HiveServer2TestUtil {
  ...
  public List<List<Object>> loadRawRowsFromTable(String tableName) {
    ...
    List<LinkedHashMap<String, Object>> rowsWithColumnNames =
        loadRowsFromTable(tableName);

    for (LinkedHashMap<String, Object> rowWithColumnNames :
         rowsWithColumnNames) {
  ...
  public List<String> loadCsvRowsFromTable(String tableName) {
    return loadRawRowsFromTable(tableName)
        .stream()
