...
public abstract class ImportJobTestCase extends BaseSqoopTestCase {
  ...
  protected String getTablePrefix() { return "IMPORT_TABLE_"; }
  ...
  protected void verifyImport(String expectedVal, String[] importCols) {
    ...
    try {
      ...
      for (FileStatus stat : stats) {
        ...
        try {
          Object readValue =
              SeqFileReader.getFirstValue(stat.getPath().toString());
  ...
  private int runSqoopTool(SqoopTool tool, String[] argv,
