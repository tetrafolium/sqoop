...
public class MockResultSet implements ResultSet {
  ...
  public static class MockBlob implements Blob {
    ...
    public long length() { return blobData().length; }
  ...
  public Blob getBlob(int i) { return new MockBlob(); }
  public Blob getBlob(String colName) { return new MockBlob(); }
  ...
  public Clob getClob(int i) { return new MockClob(); }
  public Clob getClob(String colName) { return new MockClob(); }
