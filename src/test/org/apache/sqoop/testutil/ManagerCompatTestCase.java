...
public abstract class ManagerCompatTestCase extends ImportJobTestCase {
   ...
   * NUMERIC type.
   */
  protected int getNumericScale() { return 30; }

  /**
   * Return the number of digits to use in the decimal part of a
   * NUMERIC type.
   */
  protected int getNumericDecPartDigits() { return 5; }

  /**
   * Return the number of digits to use in the integral part of a
   * DECIMAL type.
   */
  protected int getDecimalScale() { return 30; }

  /**
   * Return the number of digits to use in the decimal part of a
   * DECIMAL type.
   */
  protected int getDecimalDecPartDigits() { return 5; }

  /**
   * Define a DOUBLE column.
   */
  protected String getDoubleType() { return "DOUBLE"; }

  /**
   * Define a LONGVARCHAR type that can handle at least 24 characters.
   */
  protected String getLongVarCharType() { return "LONGVARCHAR"; }

  /**
   * Define a TIMESTAMP type that can handle null values.
   */
  protected String getTimestampType() { return "TIMESTAMP"; }

  /**
   * Define a CLOB column that can contain up to 16 MB of data.
   */
  protected String getClobType() { return "CLOB"; }
   ...
   */
  protected String getVarBinaryType() { return "VARBINARY(12)"; }

  /**
   * Define a TINYINT column that can contain 8-bit signed integers.
   */
  protected String getTinyIntType() { return "TINYINT"; }
   ...
   * test.
   */
  protected String getDateInsertStr(String insertStr) { return insertStr; }
   ...
   * test.
   */
  protected String getTimeInsertStr(String insertStr) { return insertStr; }
   ...
   * test.
   */
  protected String getTimestampInsertStr(String insertStr) { return insertStr; }
  ...
  public void testNumeric4() {
    verifyType(getNumericType(), "3000000000000000000.14159",
               getNumericSeqOutput("3000000000000000000.14159"));
  }

  @Test
  public void testNumeric5() {
    verifyType(getNumericType(), "99999999999999999999.14159",
  ...
  public void testDecimal4() {
    verifyType(getDecimalType(), "3000000000000000000.14159",
               getDecimalSeqOutput("3000000000000000000.14159"));
  }

  @Test
  public void testDecimal5() {
    verifyType(getDecimalType(), "99999999999999999999.14159",
  ...
  public void testLongVarChar() {
    ...
    verifyType(getLongVarCharType(), "'this is a long varchar'",
  ...
  public void testClob1() {
    ...
    verifyClob("'This is short CLOB data'", "This is short CLOB data",
