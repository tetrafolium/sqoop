...
public static final Log LOG =
	LogFactory.getLog(DirectNetezzaExportManualTest.class.getName());
...
protected String[] getArgv(boolean includeHadoopFlags, int rowsPerStatement,
	...
	String[] argV =
		super.getArgv(includeHadoopFlags, rowsPerStatement, statementsPerTx);
	String[] subArgV = newStrArray(argV, "--direct", "--username",
	                               NetezzaTestUtils.getNZUser(), "--password",
...
public void testValidExtraArgs() throws Exception {
	...
	String[] extraArgs = {"--", "--log-dir",      "/tmp",        "--max-errors",
		              "2",  "--trunc-string", "--ctrl-chars"};
