...
public class TestOraOopJdbcUrl extends OraOopTestCase {
  ...
  public void testParseJdbcOracleThinConnectionString() {
    ...
    try {
      ...
      fail("A JdbcOracleThinConnectionParsingError should be been thrown.");
    } catch (JdbcOracleThinConnectionParsingError ex) {
      // This is what we want to happen.
      assertTrue(
    ...
    try {
      ...
      assertTrue("An exception should be thown that tells us which JDBC driver "
                     + "was specified.",
    ...
    try {
      actual = new OraOopJdbcUrl(
                   ...
                   .parseJdbcOracleThinConnectionString();
      fail("An JdbcOracleThinConnectionParsingError should be been thrown.");
    } catch (JdbcOracleThinConnectionParsingError ex) {
      assertTrue(
  ...
  public void testGetConnectionUrl() {
    ...
    // JDBC URL...
    actual = new OraOopJdbcUrl("jdbc:oracle:thin:@hostname.domain:1521:dbsid")
                 .getConnectionUrl();
