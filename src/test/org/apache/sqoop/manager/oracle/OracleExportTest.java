...
public class OracleExportTest extends TestExport {
  ...
  public static final Log LOG =
      LogFactory.getLog(OracleExportTest.class.getName());
  ...
  public void setUp() {
    ...
    SqoopOptions options =
        new SqoopOptions(OracleUtils.CONNECT_STRING, getTableName());
  ...
  protected String[] getArgv(boolean includeHadoopFlags, int rowsPerStatement,
    ...
    String[] subArgv =
        newStrArray(additionalArgv, "--username", OracleUtils.ORACLE_USER_NAME,
  ...
  public void testUpsertTextExport() throws IOException, SQLException {
    ...
    runExport(getArgv(true, 10, 10,
                      newStrArray(null, "--update-key", "ID", "--update-mode",
                                  "allowinsert", "--oracle-escaping-disabled",
                                  "false")));
  ...
  /** Make sure mixed update/insert export work correctly. */
  @Test
  public void testUpsertTextExportWithEscapingDisabled()
  ...
  @Test
  public void testExportToTableWithNameEndingWithDollarSign()
      throws IOException, SQLException {
    testExportToTableWithName("DOLLAR$");
  }

  @Test
  public void testExportToTableWithNameContainingDollarSign()
      throws IOException, SQLException {
    testExportToTableWithName("FOO$BAR");
  }

  @Test
  public void testExportToTableWithNameContainingHashtag()
      throws IOException, SQLException {
    testExportToTableWithName("FOO#BAR");
  }
}
