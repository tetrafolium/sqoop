...
public static final Log LOG =
	LogFactory.getLog(OracleCompatTest.class.getName());
...
public void testBinaryFloat() {
	...
	verifyType("BINARY_FLOAT", getBinaryFloatInsertStr(Float.MAX_VALUE),
	           "3.4028235E38");
	verifyType("BINARY_FLOAT", getBinaryFloatInsertStr(-Float.MAX_VALUE),
	           "-3.4028235E38");
}
...
public void testBinaryDouble() {
	...
	// Max and min are from Oracle DB SQL reference for 10g release 2
	// https://stackoverflow.com/questions/3884793/why-is-double-min-value-in-not-negative
	verifyType("BINARY_DOUBLE", getBinaryDoubleInsertStr(Double.MAX_VALUE),
