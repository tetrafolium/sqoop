...
public class OraOopTypesTest extends OraOopTestCase {
    ...
    try {
      ...
      try (Statement stmt = conn.createStatement()) {
        ResultSet rs = stmt.executeQuery(
            ...
            + "T1.C14_NCHAR, "
            + "T1.C15_NVARCHAR2, "
            + "T1.C16_URITYPE.GETURL() from " + tempTableName + " T1 "
            + "minus select "
            + "T2.C1_NUM, "
            + "T2.C2_NUM, "
            + "T2.C3_NUM, "
  ...
  protected String getConnectString() { return OracleUtils.EE_CONNECT_STRING; }

  protected String getUsername() { return OracleUtils.ORACLE_EE_USER_NAME; }
