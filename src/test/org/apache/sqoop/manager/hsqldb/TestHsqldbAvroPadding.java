...
public static final Log LOG =
	LogFactory.getLog(TestHsqldbAvroPadding.class.getName());
...
protected ArgumentArrayBuilder getArgumentArrayBuilder() {
	ArgumentArrayBuilder builder =
		AvroTestUtils.getBuilderForAvroPaddingTest(this);
...
public void testAvroImportWithPadding() throws IOException {
	...
	AvroTestUtils.verify(AvroTestUtils.getExpectedResults(), getConf(),
	                     getTablePath());
}
}
