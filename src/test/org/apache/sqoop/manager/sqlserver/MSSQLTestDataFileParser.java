...
public class MSSQLTestDataFileParser {
  ...
  public static final Log LOG =
      LogFactory.getLog(MSSQLTestDataFileParser.class.getName());
  ...
  public void parse() throws Exception {
    ...
    if (br != null) {
      ...
      while ((tmp = br.readLine()) != null) {
        ...
        if (splits.length == 5 || splits.length == 6 || splits.length == 7) {
  ...
  public void setDelim(String delim1) { this.delim = delim1; }
}
