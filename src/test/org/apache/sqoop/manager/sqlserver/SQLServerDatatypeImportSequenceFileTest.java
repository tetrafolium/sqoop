...
public class SQLServerDatatypeImportSequenceFileTest
  ...
  public String getTrueBoolDbOutput() { return "1"; }

  public String getFalseBoolDbOutput() { return "0"; }

  protected String getFalseBoolSeqOutput() { return "false"; }

  protected String getFalseBoolLiteralSqlInput() { return "0"; }
      ...
      try {
        if (datatype == DATATYPES.DECIMAL || datatype == DATATYPES.NUMERIC) {
          ...
          verifyType(current.getDatatype() + "(" +
                   ...
                   datatype == DATATYPES.TEXT || datatype == DATATYPES.NTEXT ||
          ...
          verifyType(current.getDatatype() + "(" +
                         current.getData(KEY_STRINGS.SCALE) + ")",
                     "cast('" + current.getData(KEY_STRINGS.TO_INSERT) +
                         "' as binary(" + current.getData(KEY_STRINGS.SCALE) +
                         "))",
                     current.getData(KEY_STRINGS.HDFS_READBACK));
