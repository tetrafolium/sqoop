...
public static final Log LOG =
	LogFactory.getLog(SQLServerManagerImportTest.class.getName());
...
static final String CONNECT_STRING =
	HOST_URL + ";databaseName=" + DATABASE_NAME;

static final String CONNECTOR_FACTORY =
	System.getProperty("sqoop.test.msserver.connector.factory",
...
public static Iterable<? extends Object> testConfigurations() {
	ArgumentArrayBuilder builderForTableImportWithExplicitSchema =
		getArgsBuilderForTableImport().withToolOption("schema", SCHEMA_DBO);
	return Arrays.asList(
		new Object[] {getArgsBuilderForQueryImport(), DBO_TABLE_NAME},
		new Object[] {getArgsBuilderForTableImport(), DBO_TABLE_NAME},
		new Object[] {getArgsBuilderForDifferentSchemaTableImport(),
		              SCH_TABLE_NAME},
...
public SQLServerManagerImportTest(ArgumentArrayBuilder builder,
                                  String tableName) {
...
public void testImportTableResilient() throws IOException {
	logMessage.expectWarn(
		"Sqoop will use resilient operations! In case of import, the split-by column also has to be specified, unique, and in ascending order.");
...
private static ArgumentArrayBuilder getArgsBuilderForQueryImport() {
	...
	return builder.withCommonHadoopFlags(true)
	       ...
	       .withOption("target-dir", BaseSqoopTestCase.getLocalWarehouseDir() +
	                   "/" + DBO_TABLE_NAME);
}

private static ArgumentArrayBuilder
getArgsBuilderForDifferentSchemaTableImport() {
	ArgumentArrayBuilder builder = getArgsBuilder();
	return builder.withCommonHadoopFlags(true)
	       .withOption("warehouse-dir", BaseSqoopTestCase.getLocalWarehouseDir())
