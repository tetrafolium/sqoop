...
public abstract class ManagerCompatExport extends ExportJobTestCase {
  ...
  public void createTable(DATATYPES dt) throws SQLException {
    ...
    PreparedStatement statement =
        conn.prepareStatement(createTableSql, ResultSet.TYPE_FORWARD_ONLY,
  ...
  public String getColName() { return "COL_1"; }

  public String getTableName(DATATYPES dt) { return "t_" + dt.toString(); }
    ...
    for (Iterator<MSSQLTestData> itr = testdata.iterator(); itr.hasNext();) {
      ...
      try {
        ...
        if (dt.equals(DATATYPES.INT) || dt.equals(DATATYPES.BIGINT) ||
            dt.equals(DATATYPES.SMALLINT) || dt.equals(DATATYPES.TINYINT) ||
            dt.equals(DATATYPES.MONEY) || dt.equals(DATATYPES.SMALLMONEY) ||
            dt.equals(DATATYPES.TIME) || dt.equals(DATATYPES.DATETIME) ||
            dt.equals(DATATYPES.DATE) || dt.equals(DATATYPES.DATETIME2) ||
            dt.equals(DATATYPES.DATETIMEOFFSET) || dt.equals(DATATYPES.REAL) ||
            dt.equals(DATATYPES.FLOAT) || dt.equals(DATATYPES.SMALLDATETIME) ||
            dt.equals(DATATYPES.NTEXT) || dt.equals(DATATYPES.TEXT) ||
          ...
          addToReport(current, null);
                   ...
                   (dt.equals(DATATYPES.NUMERIC) || dt.equals(DATATYPES.CHAR) ||
                    dt.equals(DATATYPES.VARCHAR) ||
                    dt.equals(DATATYPES.NCHAR) ||
                    dt.equals(DATATYPES.NVARCHAR) ||
                    dt.equals(DATATYPES.VARBINARY) ||
                    dt.equals(DATATYPES.BINARY))) {
  ...
  public void verifyExport(DATATYPES dt, String[] data) throws SQLException {
    ...
    PreparedStatement statement = conn.prepareStatement(
        "SELECT " + getColName() + " FROM " + getTableName(dt),
    ...
    try {
      ...
      try {
        ...
        System.out.println("expected samples : " + data.length +
                           " Actual samples : " + cnt);
        assertEquals("Resultset must contain expected samples", data.length,
                     cnt);
      } finally {
  ...
  public void setUp() {
    ...
    try {
      ...
      String delim =
          System.getProperty("ms.datatype.test.data.file.delim", ",");
  ...
  public String getOutputFileName() { return "ManagerCompatExport.txt"; }
  ...
  public void addToReport(MSSQLTestData td, Object result) {
    try {
      ...
      if (result == null) {
        ...
        try {
          res =
              "FAILED " + removeNewLines(((AssertionError)result).getMessage());
