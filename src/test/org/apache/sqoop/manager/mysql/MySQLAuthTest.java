 ...
 *
 * Since this requires a MySQL installation with a properly configured database
 * and user, this class is named in such a way that Hadoop's default QA process
 * does not run it. You need to run this manually with -Dtestcase=MySQLAuthTest
 *
 ...
 *
 * If you don't have a database and a user which can be used by Sqoop, you can
 * create them using the following MySQL commands:
 *
