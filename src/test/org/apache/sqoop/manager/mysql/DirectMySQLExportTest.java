...
public class DirectMySQLExportTest extends TestExport {
  ...
  public static final Log LOG =
      LogFactory.getLog(DirectMySQLExportTest.class.getName());
  ...
  protected String[] getCodeGenArgv(String... extraArgs) {
    return super.getCodeGenArgv(
        mySQLTestUtils.addUserNameAndPasswordToArgs(extraArgs));
  }
  ...
  protected String[] getArgv(boolean includeHadoopFlags, int rowsPerStatement,
    ...
    String[] subArgv =
        newStrArray(mySQLTestUtils.addUserNameAndPasswordToArgs(additionalArgv),
                    "--direct");
  ...
  public void testMultiTxExport() throws IOException, SQLException {
    multiFileTest(1, 20, 1, "-D",
                  MySQLExportMapper.MYSQL_CHECKPOINT_BYTES_KEY + "=10");
  }
  ...
  public void testAuthExport() throws IOException, SQLException {
    ...
    try {
      ...
      runExport(getArgv(true, 10, 10, "--username",
                        mySQLTestUtils.getUserName(), "--password",
                        mySQLTestUtils.getUserPass(), "--connect",
  ...
  public void testEscapedByExport() throws IOException, SQLException {
    ...
    try {
      ...
      // run the export and verify that the results are good.
      runExport(
          getArgv(true, 10, 10, "--username", mySQLTestUtils.getUserName(),
                  "--password", mySQLTestUtils.getUserPass(), "--connect",
                  mySQLTestUtils.getMySqlConnectString(), "--escaped-by", "|"));
      verifyExport(3, connection);
  ...
  public void testExportInputNullStringFailsValidate() throws IOException {
    runExport(getArgv(true, 10, 10, "--username", mySQLTestUtils.getUserName(),
                      "--password", mySQLTestUtils.getUserPass(), "--connect",
                      mySQLTestUtils.getMySqlConnectString(),
  ...
  @Ignore(
      "Ignoring this test as --input-null-non-string is not supported in direct mode.")
  @Override
  @Test
  public void
  ...
  @Ignore(
      "Ignoring this test as --input-null-string is not supported in direct mode.")
  @Override
  @Test
  public void
  ...
  private void verifyTableColumnContents(Connection connection, String table,
                                         String column, ColumnGenerator gen)
      throws IOException, SQLException {
