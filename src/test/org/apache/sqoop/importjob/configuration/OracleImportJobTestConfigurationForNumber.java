 ...
 * This is the type that is probably the most commonly used to store numbers and
 * also the most problematic, as Sqoop sees this type with a 0 precision and
 * -127 scale, both invalid values. Therefore, NUMBER requires special
 * treatment. The user has to specify precision and scale when importing into
 * avro.
 */
public class OracleImportJobTestConfigurationForNumber
  ...
  public String[] getExpectedResultsForAvro() {
    String expectedRecord =
        "{\"ID\": 1, \"N1\": 100.010, \"N2\": 100, \"N3\": 100.03000}";
