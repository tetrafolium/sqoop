 ...
 * for precision and scale for NUMERIC. Also, important, that the accompanying
 * columns
 *  - NUMERIC(20) and NUMERIC(20, 5) don't get modified.
 */
public class PostgresqlImportJobTestConfigurationForNumeric
...
public String[] getExpectedResultsForAvro() {
	String expectedRecord =
		"{\"ID\": 1, \"N1\": 100.010, \"N2\": 100, \"N3\": 100.01000}";
...
public Object[] getExpectedResultsForHive() {
	return new Object[] {new Integer(1), new BigDecimal("100.010"),
		             new BigDecimal("100"), new BigDecimal("100.01000")};
}
}
