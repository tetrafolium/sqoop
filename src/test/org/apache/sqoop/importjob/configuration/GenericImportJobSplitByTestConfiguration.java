 ...
 * types without padding them with 0s, therefore when importing into avro, one
 * has to use the padding feature.
 */
public class GenericImportJobSplitByTestConfiguration
    implements ImportJobTestConfiguration, ParquetTestConfiguration {
