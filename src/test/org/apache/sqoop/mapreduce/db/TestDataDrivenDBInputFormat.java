...
public class TestDataDrivenDBInputFormat {
  ...
  private static final Log LOG =
      LogFactory.getLog(TestDataDrivenDBInputFormat.class);

  private static final String DB_NAME = "dddbif";
  private static final String DB_URL = "jdbc:hsqldb:mem:" + DB_NAME;
  ...
  public static class DateCol implements DBWritable, WritableComparable {
    ...
    public void setDate(Date dt) { this.d = dt; }
  ...
  public void testDateSplits() throws Exception {
    ...
    try {
      ...
      DBConfiguration.configureDB(job.getConfiguration(), DRIVER_CLASS, DB_URL,
