...
public class TestOptionsFileExpansion {
  ...
  private static final String[] OPTIONS_FILE_TEXT2_OUTPUT = new String[] {
      "--archives", "tools.jar,archive.jar,test.jar,ldap.jar,sasl.jar",
      "--connect",  "jdbc:jdbcspy:localhost:1521:test",
      "--username", "superman",
      "--password", "kryptonite",
  };
  ...
  private static final String[] OPTIONS_FILE_TEXT3_OUTPUT = new String[] {
      "-", "     leading spaces", "        leading and trailing spaces    ", "",
      "",
  };
  ...
  @Test
  public void testValidFreeFormQuerySingleAndDoubleQuotesInWhere()
      throws Exception {
    String[] input = new String[] {
        "--query",
  ...
  @Test
  public void testValidFreeFormQueryQuotesInTableNameAndColumnName()
      throws Exception {
    String[] input = new String[] {
        "--query",
  ...
  @Test
  public void testValidFreeFormQueryQuotesInTableNameAndColumnName2()
      throws Exception {
    String[] input = new String[] {
        "--query",
        "select * from `test\"test`  where `c'c`  = 'a\"'",
  ...
  @Test
  public void testValidFreeFormQueryQuotesInTableNameAndColumnName3()
      throws Exception {
    String[] input = new String[] {
        "--query",
  ...
  @Test
  public void testValidFreeFormQueryQuotesInTableNameAndColumnName4()
      throws Exception {
    String[] input = new String[] {
        "--query",
  ...
  @Test
  public void testInvalidFreeFormQuerySingleQuoteStartDoubleQuoteEnd()
      throws Exception {
  ...
  private void checkOptionsFile(String[] fileContent, String[] expectedOptions)
    ...
    checkOutput(prefix1, suffix1, fileContent, expectedOptions);

    String[] prefix2 = new String[] {};
    String[] suffix2 = new String[] {"yIkes"};

    checkOutput(prefix2, suffix2, fileContent, expectedOptions);

    String[] prefix3 = new String[] {"foo", "bar"};
    String[] suffix3 = new String[] {"xyz", "abc"};

    checkOutput(prefix3, suffix3, fileContent, expectedOptions);
  }
  ...
  private void checkOutput(String[] prefix, String[] suffix,
                           String[] fileContent, String[] expectedContent)
      throws Exception {
  ...
  private void assertSame(String[] prefix, String[] content, String[] suffix,
    ...
    for (int i = 0; i < suffix.length; i++) {
      Assert.assertTrue(
          actual[i + prefix.length + content.length].equals(suffix[i]));
    }
  }
