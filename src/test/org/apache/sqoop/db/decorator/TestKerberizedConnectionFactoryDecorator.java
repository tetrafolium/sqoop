...
public class TestKerberizedConnectionFactoryDecorator {
  ...
  private KerberizedConnectionFactoryDecorator
      kerberizedConnectionFactoryDecorator;
  ...
  public void before() throws Exception {
    ...
    testUser =
        UserGroupInformation.createUserForTesting("testUser", new String[] {});
    when(kerberosAuthenticator.authenticate()).thenReturn(testUser);

    kerberizedConnectionFactoryDecorator =
        new KerberizedConnectionFactoryDecorator(decoratedFactory,
                                                 kerberosAuthenticator);
  }

  @Test
  public void testCreateConnectionIsInvokedAsAuthenticatedUser()
      throws Exception {
    // We want to capture the current user when the createConnection() method is
    // invoked on the decorated factory.
    doAnswer(new Answer() {
      @Override
  ...
  @Test
  public void testCreateConnectionReturnsConnectionCreatedByDecoratedFactory()
      throws Exception {
  ...
  @Test
  public void testCreateConnectionThrowsTheSameExceptionDecoratedFactoryThrows()
      throws Exception {
