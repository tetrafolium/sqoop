...
public class TestConnFactory {
  ...
  public void testCustomFactory() throws IOException {
    ...
    ConnManager manager =
        factory.getManager(new JobData(new SqoopOptions(), new ImportTool()));
  ...
  public void testExceptionForNoManager() throws IOException {
    ...
    thrown.reportMissingExceptionWithMessage(
        "Expected IOException because of missing ConnManager ");
    factory.getManager(new JobData(new SqoopOptions(), new ImportTool()));
  }
  ...
  public void testMultipleManagers() throws IOException {
    ...
    String classNames =
        EmptyFactory.class.getName() + "," + AlwaysDummyFactory.class.getName();
  ...
  public static class DummyManager extends ConnManager {
    ...
    public String[] listDatabases() { return null; }

    public String[] listTables() { return null; }

    public String[] getColumnNames(String tableName) { return null; }

    public String[] getColumnNamesForProcedure(String procedureName) {
      return null;
    }

    public String getPrimaryKey(String tableName) { return null; }
     ...
     */
    public String toJavaType(int sqlType) { return null; }
     ...
     */
    public String toHiveType(int sqlType) { return null; }
