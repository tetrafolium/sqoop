...
public class HBaseImportTest extends HBaseTestCase {
  ...
  public void testAppendWithTimestampSucceeds() throws IOException {
    ...
    String[] argv =
        getArgv(true, "AppendTable", "AppendColumnFamily", true, null);
    ...
    argv = getIncrementalArgv(true, "AppendTable", "AppendColumnFamily", true,
                              null, true, false, "DATA_COL1",
                              "2017-03-24 01:01:01.0", null, "ignore");
   ...
   * @throws Exception
   */
  private void runInsertUpdateUpdateDeleteAndExpectValue(String nullMode,
    ...
    runImport(
        getArgv(true, "OverwriteTable", "OverwriteColumnFamily", true, null));
    ...
    runImport(getIncrementalArgv(
        true, "OverwriteTable", "OverwriteColumnFamily", true, null, false,
        false, getColName(2), "2017-03-24 01:01:01.0", null, nullMode));
    verifyHBaseCell("OverwriteTable", "0", "OverwriteColumnFamily",
                    getColName(1), "2");
    ...
    runImport(getIncrementalArgv(
        true, "OverwriteTable", "OverwriteColumnFamily", true, null, false,
        false, getColName(2), "2017-03-26 01:01:01.0", null, nullMode));
    verifyHBaseCell("OverwriteTable", "0", "OverwriteColumnFamily",
                    getColName(1), expectedValue);
  }
