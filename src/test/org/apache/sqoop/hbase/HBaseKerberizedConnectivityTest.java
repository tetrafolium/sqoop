...
public class HBaseKerberizedConnectivityTest extends HBaseTestCase {
  ...
  public HBaseKerberizedConnectivityTest() { super(miniKdcInfrastructure); }

  @Test
  public void testSqoopImportWithKerberizedHBaseConnectivitySucceeds()
      throws IOException {
    String[] argv =
        getArgv(true, HBASE_TABLE_NAME, HBASE_COLUMN_FAMILY, true, null);
    createTableWithColTypes(COLUMN_TYPES,
                            new String[] {TEST_ROW_KEY, TEST_ROW_VALUE});
