...
public class TestMainframeImportTool extends BaseSqoopTestCase {
  ...
  @Test
  public void testGetImportOptions()
      throws SecurityException, NoSuchMethodException, IllegalArgumentException,
             IllegalAccessException, InvocationTargetException {
    // To access protected method by means of reflection
    Class[] types = {};
    Object[] params = {};
    Method m_getImportOptions =
        MainframeImportTool.class.getDeclaredMethod("getImportOptions", types);
    m_getImportOptions.setAccessible(true);
    RelatedOptions rOptions =
        (RelatedOptions)m_getImportOptions.invoke(mfImportTool, params);
  ...
  @Test
  public void testNotApplyOptions()
  ...
  @Test
  public void testDataSetTypeOptionIsSet()
      throws ParseException, InvalidOptionsException {
    String[] args =
        new String[] {"--datasettype",
                      MainframeConfiguration.MAINFRAME_INPUT_DATASET_TYPE_GDG};
    ToolOptions toolOptions = new ToolOptions();
    SqoopOptions sqoopOption = new SqoopOptions();
    mfImportTool.configureOptions(toolOptions);
    sqoopOption = mfImportTool.parseArguments(args, null, sqoopOption, false);
    assertEquals(sqoopOption.getMainframeInputDatasetType(),
                 MainframeConfiguration.MAINFRAME_INPUT_DATASET_TYPE_GDG);
  }

  @Test
  public void testDefaultDataSetTypeOptionIsSet()
      throws ParseException, InvalidOptionsException {
    ...
    sqoopOption = mfImportTool.parseArguments(args, null, sqoopOption, false);
    assertEquals(
        sqoopOption.getMainframeInputDatasetType(),
  ...
  public void testInvalidDataSetTypeOptionThrowsException() {
    ...
    String[] args =
        new String[] {"--dataset", "mydataset", "--datasettype", "fjfdksjjf"};
    ToolOptions toolOptions = new ToolOptions();
    SqoopOptions sqoopOption = new SqoopOptions();
    mfImportTool.configureOptions(toolOptions);
    try {
  ...
  @Test
  public void testTapeOptionIsSet()
      throws ParseException, InvalidOptionsException {
  ...
  @Test
  public void testTapeOptionDefaultIsSet()
      throws ParseException, InvalidOptionsException {
    String[] args =
        new String[] {"--datasettype",
                      MainframeConfiguration.MAINFRAME_INPUT_DATASET_TYPE_GDG};
  ...
  @Test
  public void testTapeOptionInvalidReturnsFalse()
      throws ParseException, InvalidOptionsException {
    String[] args =
        new String[] {"--dataset", "mydatasetname", "--tape", "invalidvalue"};
    ToolOptions toolOptions = new ToolOptions();
    SqoopOptions sqoopOption = new SqoopOptions();
    mfImportTool.configureOptions(toolOptions);
    sqoopOption = mfImportTool.parseArguments(args, null, sqoopOption, false);
  ...
  @Test
  public void testFtpTransferModeAscii()
      throws ParseException, InvalidOptionsException {
    String[] args =
        new String[] {"--dataset", "mydatasetname", "--as-textfile"};
    configureAndValidateOptions(args);
    assertEquals(SqoopOptions.FileLayout.TextFile, sqoopOption.getFileLayout());
  }
  @Test
  public void testFtpTransferModeDefaultsToAscii()
      throws ParseException, InvalidOptionsException {
  ...
  @Test
  public void testAsBinaryFileSetsCorrectFileLayoutAndDefaultBufferSize()
      throws ParseException, InvalidOptionsException {
    String[] args =
        new String[] {"--dataset", "mydatasetname", "--as-binaryfile"};
    configureAndValidateOptions(args);
    assertEquals(SqoopOptions.FileLayout.BinaryFile,
                 sqoopOption.getFileLayout());
    assertEquals(MainframeConfiguration
                     .MAINFRAME_FTP_TRANSFER_BINARY_DEFAULT_BUFFER_SIZE,
                 sqoopOption.getBufferSize());
  }
  ...
  public void testSetBufferSize()
    ...
    String[] args =
        new String[] {"--dataset", "mydatasetname", "--as-binaryfile",
                      "--buffersize", EXPECTED_BUFFER.toString()};
    configureAndValidateOptions(args);
    assertEquals(SqoopOptions.FileLayout.BinaryFile,
                 sqoopOption.getFileLayout());
  ...
  @Test
  public void testBufferSizeWithoutBinaryThrowsException()
      throws ParseException, InvalidOptionsException {
    final Integer EXPECTED_BUFFER = 1024;
  ...
  @Test
  public void testInvalidBufferSizeThrowsNumberFormatException()
      throws ParseException, InvalidOptionsException {
  ...
  private void configureAndValidateOptions(String[] args)
      throws ParseException, InvalidOptionsException {
    mfImportTool.configureOptions(toolOptions);
    sqoopOption = mfImportTool.parseArguments(args, null, sqoopOption, false);
    mfImportTool.validateImportOptions(sqoopOption);
