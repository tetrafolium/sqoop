...
public class TestToolPlugin {
  ...
  public static final Log LOG =
      LogFactory.getLog(TestToolPlugin.class.getName());
  ...
  public static class PluginClass extends ToolPlugin {
    public List<ToolDesc> getTools() {
      return Collections.singletonList(
          new ToolDesc("fooTool", FooTool.class, "does foo things"));
    }
  }
  ...
  public static class FooTool extends BaseSqoopTool {
    ...
    static String getLastUser() { return lastUser; }

    private static void setLastUser(String last) { lastUser = last; }

    public FooTool() { super("fooTool"); }
  ...
  public static class OverridePlugin extends ToolPlugin {
    public List<ToolDesc> getTools() {
      return Collections.singletonList(
          new ToolDesc("import", FooTool.class, "replaces 'import' with foo"));
    }
  }
