...
public void testGetShortName() throws UnsupportedCodecException {
	...
	thrown.reportMissingExceptionWithMessage(
		"Expected UnsupportedCodecException with invalid codec name during getting "
		+ "short codec name");
...
throws UnsupportedCodecException {
	assertEquals(expected, CodecMap.getCodecShortNameByName(
			     codecName, new Configuration()));
}
...
public void testUnrecognizedCodec() throws UnsupportedCodecException {
	thrown.expect(UnsupportedCodecException.class);
	thrown.reportMissingExceptionWithMessage(
		"Expected UnsupportedCodecException with invalid codec name");
