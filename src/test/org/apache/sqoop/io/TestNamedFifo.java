...
public class TestNamedFifo {
  ...
  public static final Log LOG =
      LogFactory.getLog(TestNamedFifo.class.getName());
  ...
  private static class ReaderThread extends Thread {
    ...
    public ReaderThread(File f) { this.file = f; }
    ...
    public void run() {
      ...
      try {
        ...
        if (!MSG.trim().equals(line)) {
          throw new IOException("Expected " + MSG.trim() + " but got " + line);
        }
        ...
        if (null == line) {
          ...
          throw new IOException("Expected " + MSG2.trim() + " but got " + line);
        }
  ...
  private static class WriterThread extends Thread {
    ...
    public WriterThread(File f) { this.file = f; }
