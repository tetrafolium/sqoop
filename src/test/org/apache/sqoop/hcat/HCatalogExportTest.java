...
public class HCatalogExportTest extends ExportJobTestCase {
  ...
  protected void assertColMinAndMax(String colName, ColumnGenerator generator)
    ...
    utils.assertSqlColValForRowId(conn, table, minId, colName, false,
                                  expectedMin);
    utils.assertSqlColValForRowId(conn, table, maxId, colName, false,
                                  expectedMax);
  }
  ...
  protected void runHCatExport(List<String> addlArgsArray,
    ...
    utils.createHCatTable(CreateMode.CREATE_AND_LOAD, totalRecords, table,
                          cols);
    utils.createSqlTable(getConnection(), true, totalRecords, table, false,
                         cols);
    ...
    String[] exportArgs = getArgv(
        true, 10, 10, newStrArray(argv, addlArgsArray.toArray(new String[0])));
  ...
  public void testExportWithColumnNameValue() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            ...
            KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            valueColumnThatHadIssuesWithClassWriter, "int", Types.INTEGER,
            HCatFieldSchema.Type.INT, 5, 5, 10, 10, KeyType.NOT_A_KEY)};
    List<String> addlArgsArray = new ArrayList<String>();
    runHCatExport(addlArgsArray, TOTAL_RECORDS, table, cols);
  }
  ...
  public void testBinaryTypes() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            ...
            KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(1), "varbinary(10)", Types.BINARY,
            HCatFieldSchema.Type.BINARY, 0, 0, bb.array(), bb.array(),
            KeyType.NOT_A_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
  ...
  public void testColumnProjection() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            ...
            HCatFieldSchema.Type.STRING, 0, 0, "1", null, KeyType.NOT_A_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
  ...
  public void testPublishExportJobData() throws Exception {
    ...
    List<String> addlArgsArray = new ArrayList<String>();
    addlArgsArray.add("-D");
    addlArgsArray.add(ConfigurationConstants.DATA_PUBLISH_CLASS + "=" +
