...
public class HCatalogImportTest extends ImportJobTestCase {
  ...
  private List<String> getConfigParams() { return configParams; }
  ...
  private void validateHCatRecords(final List<HCatRecord> recs,
    ...
    if (recs.size() != expectedCount) {
      fail("Expected records = " + expectedCount + ", actual = " + recs.size());
      return;
    }
      ...
      for (ColumnGenerator col : cols) {
        ...
        try {
          ...
          throw new IOException(
              "Unable to get value for field " + name + " from hcat record", e);
        }
        LOG.info("Validating field: " + name + " (expected = " + expectedVal +
                 ", actual = " + actualVal + ")");
        HCatalogTestUtils.assertEquals(expectedVal, actualVal);
      }
    }
  ...
  protected void runHCatImport(List<String> addlArgsArray, int totalRecords,
                               String table, ColumnGenerator[] cols,
  ...
  protected void runHCatQueryImport(List<String> addlArgsArray,
                                    int totalRecords, String table,
                                    ColumnGenerator[] cols, String[] cNames)
      throws Exception {
    runHCatImport(addlArgsArray, totalRecords, table, cols, cNames, false,
                  true);
  }
  ...
  protected void runHCatImport(List<String> addlArgsArray, int totalRecords,
                               String table, ColumnGenerator[] cols,
                               String[] cNames, boolean dontCreate,
  ...
  public void testIntTypes() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "boolean", Types.BOOLEAN,
            HCatFieldSchema.Type.BOOLEAN, 0, 0, Boolean.TRUE, Boolean.TRUE,
            KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(1), "tinyint",
                                       Types.INTEGER, HCatFieldSchema.Type.INT,
                                       0, 0, 10, 10, KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(2), "smallint",
                                       Types.INTEGER, HCatFieldSchema.Type.INT,
                                       0, 0, 100, 100, KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(3), "int",
                                       Types.INTEGER, HCatFieldSchema.Type.INT,
                                       0, 0, 1000, 1000, KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(4), "bigint",
                                       Types.BIGINT,
                                       HCatFieldSchema.Type.BIGINT, 0, 0,
                                       10000L, 10000L, KeyType.NOT_A_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
  ...
  public void testFloatTypes() throws Exception {
    ...
    String table = getTableName().toUpperCase();
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(0), "float",
                                       Types.FLOAT, HCatFieldSchema.Type.FLOAT,
                                       0, 0, 10.0F, 10.F, KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(1), "real",
                                       Types.FLOAT, HCatFieldSchema.Type.FLOAT,
                                       0, 0, 20.0F, 20.0F, KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(2), "double", Types.DOUBLE,
            HCatFieldSchema.Type.DOUBLE, 0, 0, 30.0D, 30.0D, KeyType.NOT_A_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
    setExtraArgs(addlArgsArray);
    runHCatImport(addlArgsArray, TOTAL_RECORDS, table, cols, null);
  ...
  public void testDecimalTypes() throws Exception {
    ...
    HiveDecimal expectedValue1 =
        HiveDecimal.create(new BigDecimal("454018528782.42006"), allowRoundig);
    BigDecimal inputValue2 =
        new BigDecimal("87658675864540185.123456789123456789");
    HiveDecimal expectedValue2 = HiveDecimal.create(
        new BigDecimal("87658675864540185.12346"), allowRoundig);
    int precision = 22;
    int scale = 5;

    ColumnGenerator[] hcatColumns = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), dbTypeNumeric, sqlTypeNumeric,
            hcatTypeDecimal, precision, scale, expectedValue1, inputValue1,
            KeyType.NOT_A_KEY),

        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(1), dbTypeDecimal, sqlTypeDecimal,
            hcatTypeDecimal, precision, scale, expectedValue2, inputValue2,
            KeyType.NOT_A_KEY)};
    List<String> addlArgsArray = new ArrayList<String>();
    setExtraArgs(addlArgsArray);
  ...
  public void testNumberTypes() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "numeric(18,2)", Types.NUMERIC,
            HCatFieldSchema.Type.STRING, 0, 0, "1000", new BigDecimal("1000"),
            KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(1), "decimal(18,2)", Types.DECIMAL,
            HCatFieldSchema.Type.STRING, 0, 0, "2000", new BigDecimal("2000"),
            KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(2), "decimal(18,2)", Types.DECIMAL,
            HCatFieldSchema.Type.DECIMAL, 18, 2,
            HiveDecimal.create(new BigDecimal("2000")), new BigDecimal("2000"),
            KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(3), "decimal(18,2)", Types.DECIMAL,
            HCatFieldSchema.Type.VARCHAR, 20, 0, new HiveVarchar("1999", 20),
            new BigDecimal("1999"), KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(4), "decimal(18,2)", Types.DECIMAL,
            HCatFieldSchema.Type.CHAR, 20, 0, new HiveChar("1998", 20),
            new BigDecimal("1998"), KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(5), "int", Types.INTEGER,
            HCatFieldSchema.Type.VARCHAR, 20, 0, new HiveVarchar("2001", 20),
            new BigDecimal("2001"), KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(6), "int", Types.INTEGER,
            HCatFieldSchema.Type.CHAR, 20, 0, new HiveChar("2002", 20),
            new BigDecimal("2002"), KeyType.NOT_A_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
    setExtraArgs(addlArgsArray);
    runHCatImport(addlArgsArray, TOTAL_RECORDS, table, cols, null);
  ...
  public void testDateTypes() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "date", Types.DATE,
            HCatFieldSchema.Type.STRING, 0, 0, "2013-12-31",
            new Date(113, 11, 31), KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(1), "date", Types.DATE,
            HCatFieldSchema.Type.DATE, 0, 0, new Date(113, 11, 31),
            new Date(113, 11, 31), KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(2), "time",
                                       Types.TIME, HCatFieldSchema.Type.STRING,
                                       0, 0, "10:11:12", new Time(10, 11, 12),
                                       KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(3), "timestamp", Types.TIMESTAMP,
            HCatFieldSchema.Type.STRING, 0, 0, "2013-12-31 10:11:12.0",
            new Timestamp(113, 11, 31, 10, 11, 12, 0), KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(4), "timestamp", Types.TIMESTAMP,
            HCatFieldSchema.Type.TIMESTAMP, 0, 0,
  ...
  public void testDateTypesToBigInt() throws Exception {
    ...
    String table = getTableName().toUpperCase();
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(0), "date",
                                       Types.DATE, HCatFieldSchema.Type.BIGINT,
                                       0, 0, 0 - offset, new Date(70, 0, 1),
                                       KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(1), "time",
                                       Types.TIME, HCatFieldSchema.Type.BIGINT,
                                       0, 0, 36672000L - offset,
                                       new Time(10, 11, 12), KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(2), "timestamp", Types.TIMESTAMP,
  ...
  public void testStringTypes() throws Exception {
    ...
    String table = getTableName().toUpperCase();
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(0), "char(14)",
                                       Types.CHAR, HCatFieldSchema.Type.STRING,
                                       0, 0, "string to test", "string to test",
                                       KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(1), "char(14)",
                                       Types.CHAR, HCatFieldSchema.Type.CHAR,
                                       14, 0,
                                       new HiveChar("string to test", 14),
                                       "string to test", KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(2), "char(14)",
                                       Types.CHAR, HCatFieldSchema.Type.VARCHAR,
                                       14, 0,
                                       new HiveVarchar("string to test", 14),
                                       "string to test", KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(3), "longvarchar", Types.LONGVARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, "string to test",
            "string to test", KeyType.NOT_A_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
    setExtraArgs(addlArgsArray);
  ...
  public void testBinaryTypes() throws Exception {
    ...
    ByteBuffer bb10 =
        ByteBuffer.wrap(new byte[] {0, 1, 2, 0, 0, 0, 0, 0, 0, 0});
    final int TOTAL_RECORDS = 1 * 10;
    String table = getTableName().toUpperCase();
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "binary(10)", Types.BINARY,
            HCatFieldSchema.Type.BINARY, 0, 0, bb10.array(), bb10.array(),
            KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(1), "longvarbinary", Types.BINARY,
            HCatFieldSchema.Type.BINARY, 0, 0, bb.array(), bb.array(),
            KeyType.NOT_A_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
    setExtraArgs(addlArgsArray);
  ...
  public void testColumnProjection() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, null, null, KeyType.NOT_A_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
    List<String> cfgParams = new ArrayList<String>();
    cfgParams.add("-D");
    cfgParams.add(SqoopHCatUtilities.DEBUG_HCAT_IMPORT_MAPPER_PROP + "=true");
  ...
  public void testColumnProjectionMissingPartKeys() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, null, null, KeyType.DYNAMIC_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
    List<String> cfgParams = new ArrayList<String>();
    cfgParams.add("-D");
  ...
  public void testStaticPartitioning() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, "1", "1", KeyType.STATIC_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
  ...
  public void testStaticPartitioningWithMultipleKeys() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            ...
            HCatFieldSchema.Type.STRING, 0, 0, "1", "1", KeyType.STATIC_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(1), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, "2", "2", KeyType.STATIC_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
  ...
  public void testDynamicPartitioning() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, "1", "1", KeyType.DYNAMIC_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
    setExtraArgs(addlArgsArray);
    runHCatImport(addlArgsArray, TOTAL_RECORDS, table, cols, null);
  ...
  public void testStaticAndDynamicPartitioning() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        ...
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(1), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, "2", "2", KeyType.DYNAMIC_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
    addlArgsArray.add("--hive-partition-key");
    addlArgsArray.add("col0");
  ...
  public void testMultipleStaticKeysAndDynamicPartitioning() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        ...
        HCatalogTestUtils.colGenerator(
            ...
            HCatFieldSchema.Type.STRING, 0, 0, "2", "2", KeyType.STATIC_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(2), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, "3", "3", KeyType.DYNAMIC_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
    addlArgsArray.add("--hcatalog-partition-keys");
    addlArgsArray.add("col0,col1");
  ...
  public void testTableCreation() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, new HiveVarchar("1", 20), "1",
            KeyType.STATIC_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(1), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, new HiveVarchar("2", 20), "2",
            KeyType.DYNAMIC_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
  ...
  public void testExternalTableCreation() throws Exception {
    externalTableCreationCoreTest(true, "--" + CREATE_HCATALOG_TABLE_ARG,
  ...
  @Test
  public void testExternalTableDropAndCreationWithExistingTargetTable()
      throws Exception {
    utils.createHCatExternalTable(getTableName().toUpperCase());
    externalTableCreationCoreTest(false, "--" + DROP_AND_CREATE_HCATALOG_TABLE,
                                  "--" + HCATALOG_EXTERNAL_TABLE_ARG,
                                  "--" + HCATALOG_STORAGE_STANZA_ARG,
                                  TABLEPROPERTIES_ORC_NONTRANSACTIONAL);
  }
  ...
  public void testExternalTableCreationFailsDueToExistingTable()
      throws Exception {
    utils.createHCatExternalTable(getTableName().toUpperCase());
    externalTableCreationCoreTest(false, "--" + CREATE_HCATALOG_TABLE_ARG,
                                  "--" + HCATALOG_EXTERNAL_TABLE_ARG,
                                  "--" + HCATALOG_STORAGE_STANZA_ARG,
                                  TABLEPROPERTIES_ORC_NONTRANSACTIONAL);
  }
  ...
  public void testExternalTableCreationFailsIfNoCreateOrDropTablePresent()
      throws Exception {
    externalTableCreationCoreTest(true, "--" + HCATALOG_EXTERNAL_TABLE_ARG,
                                  "--" + HCATALOG_STORAGE_STANZA_ARG,
                                  TABLEPROPERTIES_ORC_NONTRANSACTIONAL);
  }

  private void externalTableCreationCoreTest(boolean dropHCatTableIfExists,
                                             String... lArgs) throws Exception {
    final int TOTAL_RECORDS = 1 * 10;
    String table = getTableName().toUpperCase();
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
  ...
  public void testTableCreationWithPartition() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.VARCHAR, 20, 0, new HiveVarchar("1", 20), "1",
            KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(1), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.VARCHAR, 20, 0, new HiveVarchar("2", 20), "2",
            KeyType.STATIC_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
    addlArgsArray.add("--hive-partition-key");
  ...
  public void testHiveDropDelims() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, "Test", "\u0001\n\rTest",
            KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(1), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, "Test2", "\u0001\r\nTest2",
            KeyType.NOT_A_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
  ...
  public void testDynamicKeyInMiddle() throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(0), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, "1", "1", KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(
            HCatalogTestUtils.forIdx(1), "varchar(20)", Types.VARCHAR,
            HCatFieldSchema.Type.STRING, 0, 0, "2", "2", KeyType.DYNAMIC_KEY),
    };
  ...
  public void testCreateTableWithPreExistingTable() throws Exception {
    ...
    try {
      ...
      LOG.debug("Caught expected exception while running "
                    + " create-hcatalog-table with pre-existing table test",
                e);
    }
  }
  ...
  public void testTableWithNonIdentColChars() throws Exception {
    ...
    String table = getTableName().toUpperCase();
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator("A-B+C*D/E", "tinyint", Types.INTEGER,
                                       HCatFieldSchema.Type.INT, 0, 0, 10, 10,
                                       KeyType.NOT_A_KEY),
    };
    List<String> addlArgsArray = new ArrayList<String>();
    setExtraArgs(addlArgsArray);
  ...
  public void testPublishQueryImportData() throws Exception {
    ...
    List<String> cfgParams = new ArrayList<String>();
    cfgParams.add("-D");
    cfgParams.add(ConfigurationConstants.DATA_PUBLISH_CLASS + "=" +
                  DummyDataPublisher.class.getName());
    setConfigParams(cfgParams);
    runHCatQueryImport(new ArrayList<String>(), TOTAL_RECORDS, table, cols,
                       null);
  ...
  private void createHCatTableAndView(String tableName, String viewName,
                                      SqoopHCatUtilities utils)
      throws Exception {
    ...
    ColumnGenerator[] cols = new ColumnGenerator[] {
        HCatalogTestUtils.colGenerator(
            ...
            HCatFieldSchema.Type.BOOLEAN, 0, 0, Boolean.TRUE, Boolean.TRUE,
            KeyType.NOT_A_KEY),
        HCatalogTestUtils.colGenerator(HCatalogTestUtils.forIdx(1), "int",
                                       Types.INTEGER, HCatFieldSchema.Type.INT,
                                       5, 5, 10, 10, KeyType.NOT_A_KEY)};
    testUtils.createHCatTable(CreateMode.CREATE_AND_LOAD, 10, tableName, cols);
    String createViewCmd = "drop view " + viewName + "; create view " +
