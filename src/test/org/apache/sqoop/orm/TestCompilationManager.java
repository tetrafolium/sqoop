...
public class TestCompilationManager {
  ...
  public void testPotentialOuterClassNameOfWithPlainClassName() {
    ...
    assertEquals(expectedOutput,
                 compilationManager.potentialOuterClassNameOf(inputClassName));
  }
  ...
  @Test
  public void
  testPotentialOuterClassNameOfWithOuterClassNameContainingDollarSign() {
  ...
  @Test
  public void
  testPotentialOuterClassNameOfWithOuterClassNameEndingWithDollarSign() {
  ...
  public void testIsInnerClassWithOuterClass() {
    ...
    assertEquals(expectedOutput,
                 compilationManager.isInnerClass(inputSourceFileName));
  }
  ...
  public void testIsOuterClassWithExistingSourceFile() {
    ...
    assertEquals(expectedOutput,
                 compilationManager.isOuterClass(inputSourceFileName));
  }
  ...
  public void testIncludeFileInJarWithNonClassFile() {
    ...
    assertEquals(expectedOutput,
                 compilationManager.includeFileInJar(inputClassFileName));
  }
