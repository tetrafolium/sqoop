...
public class TestAvroImportExportRoundtrip extends ImportJobTestCase {
  ...
  public static final Log LOG =
      LogFactory.getLog(TestAvroImportExportRoundtrip.class.getName());
  ...
  public void testRoundtripQuery() throws IOException, SQLException {
    ...
    deleteTableData();
    runExport(
        getExportArgvForQuery(true, 10, 10, newStrArray(argv, "-m", "" + 1)));
  ...
  protected String[] getExportArgv(boolean includeHadoopFlags, int rowsPerStmt,
                                   int statementsPerTx,
  ...
  protected String[] getExportArgvForQuery(boolean includeHadoopFlags,
                                           int rowsPerStmt, int statementsPerTx,
                                           String... additionalArgv) {
    ArrayList<String> args = formatAdditionalArgs(additionalArgv);
  ...
  private void deleteTableData() throws SQLException {
    ...
    PreparedStatement statement = conn.prepareStatement(
        "DELETE FROM " + getTableName(), ResultSet.TYPE_FORWARD_ONLY,
