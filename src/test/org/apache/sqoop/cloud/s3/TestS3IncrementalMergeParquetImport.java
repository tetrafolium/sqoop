...
public class TestS3IncrementalMergeParquetImport
    extends AbstractTestIncrementalMergeParquetImport {

  @ClassRule
  public static S3CredentialsRule credentialsRule = new S3CredentialsRule();

  public TestS3IncrementalMergeParquetImport() { super(credentialsRule); }
}
