...
public class TestS3IncrementalAppendParquetImport
    extends AbstractTestIncrementalAppendParquetImport {

  @ClassRule
  public static S3CredentialsRule credentialsRule = new S3CredentialsRule();

  public TestS3IncrementalAppendParquetImport() { super(credentialsRule); }
}
