...
/**
 * The task of this rule is to initialize the cloud FileSystem object and the
 * test directories before the tests and clean them up after. This FileSystem
 * object is used to assert the output of a Sqoop job. If the credentials are
 * not provided for the cloud system the tests will be skipped.
 */
