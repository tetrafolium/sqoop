...
/**
 * The task of this rule is to execute the credential generator command for the
 * given cloud storage and store its output for later use. If the credential
 * generator command is not provided the tests using this rule will be skipped.
 *
 ...
 *    <li>how apply the credentials to the Hadoop configurations and Sqoop
 * arguments for the tests</li>
 *  </ul>
 */
