...
public class CloudTestDataSet {
  ...
  private final String[] columnTypes = {"INT", "VARCHAR(25)", "VARCHAR(25)",
                                        "INT"};
  private final String[] columnNamesForMerge = {"DEBUT", "SUPERHERO1",
                                                "SUPERHERO2", "RECORD_DATE"};
  private final String[] columnTypesForMerge = {"INT", "VARCHAR(25)",
                                                "VARCHAR(25)", "TIMESTAMP"};
  ...
  private final String expectedInitialTimestampForMerge =
      "2018-07-23 15:00:00.0";
  ...
  public List<List<Object>> getInitialInputDataForMerge() {
    return Arrays.asList(
        ...
        Arrays.asList(1974, "Iron Fist", "The Punisher",
                      initialTimestampForMerge));
  }
  ...
  public String[] getExpectedTextOutput() {
    return new String[] {"1,Ironman,Marvel,1963", "2,Wonder Woman,DC,1941",
                         "3,Batman,DC,1939", "4,Hulk,Marvel,1962"};
  }
  ...
  public List<String> getExpectedParquetOutput() {
    return asList("1,Ironman,Marvel,1963", "2,Wonder Woman,DC,1941",
                  "3,Batman,DC,1939", "4,Hulk,Marvel,1962");
  }
  ...
  public List<String> getExpectedParquetOutputWithTimestampColumn() {
    return asList("1940,Black Widow,Falcon," +
                      timeFromString(initialTimestampForMerge),
                  "1974,Iron Fist,The Punisher," +
                      timeFromString(initialTimestampForMerge));
  }
  ...
  public String[] getColumnNamesForMerge() { return columnNamesForMerge; }

  public String[] getColumnTypesForMerge() { return columnTypesForMerge; }
