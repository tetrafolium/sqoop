...
public abstract class AbstractTestIncrementalMergeTextImport
    extends CloudImportJobTestCase {

  public static final Log LOG =
      LogFactory.getLog(AbstractTestIncrementalMergeTextImport.class.getName());
  ...
  protected AbstractTestIncrementalMergeTextImport(
      CloudCredentialsRule credentialsRule) {
    super(credentialsRule);
  }

  @Test
  public void testIncrementalMergeAsTextFileWhenNoNewRowIsImported()
      throws Exception {
    ...
    TextFileTestUtils.verify(getDataSet().getExpectedTextOutputBeforeMerge(),
                             fileSystemRule.getCloudFileSystem(),
                             fileSystemRule.getTargetDirPath(),
                             REDUCE_OUTPUT_FILE_00000);
  }
  ...
  public void testIncrementalMergeAsTextFile() throws Exception {
    ...
    TextFileTestUtils.verify(getDataSet().getExpectedTextOutputAfterMerge(),
                             fileSystemRule.getCloudFileSystem(),
                             fileSystemRule.getTargetDirPath(),
                             REDUCE_OUTPUT_FILE_00000);
  }
  ...
  @Test
  public void
  testIncrementalMergeAsTextFileWithMapreduceOutputBasenameProperty()
      throws Exception {
    ...
    TextFileTestUtils.verify(getDataSet().getExpectedTextOutputAfterMerge(),
                             fileSystemRule.getCloudFileSystem(),
                             fileSystemRule.getTargetDirPath(),
                             CUSTOM_REDUCE_OUTPUT_FILE_00000);
  }
  ...
  private String[] getIncrementalMergeArgs(
